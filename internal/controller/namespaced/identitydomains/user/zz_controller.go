...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	metricRecorder := metrics.NewMetricRecorder(v1alpha1.User_GroupVersionKind, mgr, o.PollInterval)
	if err := mgr.Add(metricRecorder); err != nil {
		return errors.Wrap(err, "cannot register Terraform metric recorder")
	}
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["oci_identity_domains_user"],
