...
type SchedulerScheduleInitParameters struct {
...
type SchedulerScheduleObservation struct {
...
type SchedulerScheduleParameters struct {
...
// SchedulerScheduleSpec defines the desired state of SchedulerSchedule
type SchedulerScheduleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SchedulerScheduleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SchedulerScheduleInitParameters `json:"initProvider,omitempty"`
}

// SchedulerScheduleStatus defines the observed state of SchedulerSchedule.
type SchedulerScheduleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SchedulerScheduleObservation `json:"atProvider,omitempty"`
}
...
// SchedulerSchedule is the Schema for the SchedulerSchedules API. Provides the Schedule resource in Oracle Cloud Infrastructure Resource Scheduler service
...
type SchedulerSchedule struct {
	...
	Spec   SchedulerScheduleSpec   `json:"spec"`
	Status SchedulerScheduleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SchedulerScheduleList contains a list of SchedulerSchedules
type SchedulerScheduleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SchedulerSchedule `json:"items"`
}

// Repository type metadata.
var (
	SchedulerSchedule_Kind             = "SchedulerSchedule"
	SchedulerSchedule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SchedulerSchedule_Kind}.String()
	SchedulerSchedule_KindAPIVersion   = SchedulerSchedule_Kind + "." + CRDGroupVersion.String()
	SchedulerSchedule_GroupVersionKind = CRDGroupVersion.WithKind(SchedulerSchedule_Kind)
)

func init() {
	SchemeBuilder.Register(&SchedulerSchedule{}, &SchedulerScheduleList{})
}
