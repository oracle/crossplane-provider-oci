...
type SafeTargetDatabaseInitParameters struct {
	...
	// The details required to establish a TLS enabled connection.
	TLSConfig []SafeTargetDatabaseTLSConfigInitParameters `json:"tlsConfig,omitempty" tf:"tls_config,omitempty"`
}

type SafeTargetDatabaseObservation struct {
	...
	// The details required to establish a TLS enabled connection.
	TLSConfig []SafeTargetDatabaseTLSConfigObservation `json:"tlsConfig,omitempty" tf:"tls_config,omitempty"`
...
type SafeTargetDatabaseParameters struct {
	...
	// The details required to establish a TLS enabled connection.
	// +kubebuilder:validation:Optional
	TLSConfig []SafeTargetDatabaseTLSConfigParameters `json:"tlsConfig,omitempty" tf:"tls_config,omitempty"`
}

type SafeTargetDatabaseTLSConfigInitParameters struct {
...
type SafeTargetDatabaseTLSConfigObservation struct {
...
type SafeTargetDatabaseTLSConfigParameters struct {
...
// SafeTargetDatabaseSpec defines the desired state of SafeTargetDatabase
type SafeTargetDatabaseSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeTargetDatabaseParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeTargetDatabaseInitParameters `json:"initProvider,omitempty"`
}

// SafeTargetDatabaseStatus defines the observed state of SafeTargetDatabase.
type SafeTargetDatabaseStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeTargetDatabaseObservation `json:"atProvider,omitempty"`
}
...
// SafeTargetDatabase is the Schema for the SafeTargetDatabases API. Provides the Target Database resource in Oracle Cloud Infrastructure Data Safe service
...
type SafeTargetDatabase struct {
	...
	Spec   SafeTargetDatabaseSpec   `json:"spec"`
	Status SafeTargetDatabaseStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeTargetDatabaseList contains a list of SafeTargetDatabases
type SafeTargetDatabaseList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeTargetDatabase `json:"items"`
}

// Repository type metadata.
var (
	SafeTargetDatabase_Kind             = "SafeTargetDatabase"
	SafeTargetDatabase_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeTargetDatabase_Kind}.String()
	SafeTargetDatabase_KindAPIVersion   = SafeTargetDatabase_Kind + "." + CRDGroupVersion.String()
	SafeTargetDatabase_GroupVersionKind = CRDGroupVersion.WithKind(SafeTargetDatabase_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeTargetDatabase{}, &SafeTargetDatabaseList{})
}
