...
type SafeTargetDatabaseGroupInitParameters struct {
...
type SafeTargetDatabaseGroupObservation struct {
...
type SafeTargetDatabaseGroupParameters struct {
...
// SafeTargetDatabaseGroupSpec defines the desired state of SafeTargetDatabaseGroup
type SafeTargetDatabaseGroupSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeTargetDatabaseGroupParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeTargetDatabaseGroupInitParameters `json:"initProvider,omitempty"`
}

// SafeTargetDatabaseGroupStatus defines the observed state of SafeTargetDatabaseGroup.
type SafeTargetDatabaseGroupStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeTargetDatabaseGroupObservation `json:"atProvider,omitempty"`
}
...
// SafeTargetDatabaseGroup is the Schema for the SafeTargetDatabaseGroups API. Provides the Target Database Group resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeTargetDatabaseGroup struct {
	...
	Spec   SafeTargetDatabaseGroupSpec   `json:"spec"`
	Status SafeTargetDatabaseGroupStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeTargetDatabaseGroupList contains a list of SafeTargetDatabaseGroups
type SafeTargetDatabaseGroupList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeTargetDatabaseGroup `json:"items"`
}

// Repository type metadata.
var (
	SafeTargetDatabaseGroup_Kind             = "SafeTargetDatabaseGroup"
	SafeTargetDatabaseGroup_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeTargetDatabaseGroup_Kind}.String()
	SafeTargetDatabaseGroup_KindAPIVersion   = SafeTargetDatabaseGroup_Kind + "." + CRDGroupVersion.String()
	SafeTargetDatabaseGroup_GroupVersionKind = CRDGroupVersion.WithKind(SafeTargetDatabaseGroup_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeTargetDatabaseGroup{}, &SafeTargetDatabaseGroupList{})
}
