...
type MaskingFormatsFormatEntriesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/datalabelingservice/v1alpha1.SafeLibraryMaskingFormat
	...
	// Reference to a SafeLibraryMaskingFormat in datalabelingservice to populate libraryMaskingFormatId.
	// +kubebuilder:validation:Optional
	LibraryMaskingFormatIDRef *v1.Reference `json:"libraryMaskingFormatIdRef,omitempty" tf:"-"`

	// Selector for a SafeLibraryMaskingFormat in datalabelingservice to populate libraryMaskingFormatId.
	// +kubebuilder:validation:Optional
...
type SafeMaskingPoliciesMaskingColumnInitParameters struct {
...
type SafeMaskingPoliciesMaskingColumnObservation struct {
...
type SafeMaskingPoliciesMaskingColumnParameters struct {
...
// SafeMaskingPoliciesMaskingColumnSpec defines the desired state of SafeMaskingPoliciesMaskingColumn
type SafeMaskingPoliciesMaskingColumnSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeMaskingPoliciesMaskingColumnParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeMaskingPoliciesMaskingColumnInitParameters `json:"initProvider,omitempty"`
}

// SafeMaskingPoliciesMaskingColumnStatus defines the observed state of SafeMaskingPoliciesMaskingColumn.
type SafeMaskingPoliciesMaskingColumnStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeMaskingPoliciesMaskingColumnObservation `json:"atProvider,omitempty"`
}
...
// SafeMaskingPoliciesMaskingColumn is the Schema for the SafeMaskingPoliciesMaskingColumns API. Provides the Masking Policies Masking Column resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeMaskingPoliciesMaskingColumn struct {
	...
	Spec   SafeMaskingPoliciesMaskingColumnSpec   `json:"spec"`
	Status SafeMaskingPoliciesMaskingColumnStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeMaskingPoliciesMaskingColumnList contains a list of SafeMaskingPoliciesMaskingColumns
type SafeMaskingPoliciesMaskingColumnList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeMaskingPoliciesMaskingColumn `json:"items"`
}

// Repository type metadata.
var (
	SafeMaskingPoliciesMaskingColumn_Kind             = "SafeMaskingPoliciesMaskingColumn"
	SafeMaskingPoliciesMaskingColumn_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeMaskingPoliciesMaskingColumn_Kind}.String()
	SafeMaskingPoliciesMaskingColumn_KindAPIVersion   = SafeMaskingPoliciesMaskingColumn_Kind + "." + CRDGroupVersion.String()
	SafeMaskingPoliciesMaskingColumn_GroupVersionKind = CRDGroupVersion.WithKind(SafeMaskingPoliciesMaskingColumn_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeMaskingPoliciesMaskingColumn{}, &SafeMaskingPoliciesMaskingColumnList{})
}
