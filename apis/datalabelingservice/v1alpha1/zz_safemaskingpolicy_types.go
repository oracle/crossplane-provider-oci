...
type SafeMaskingPolicyInitParameters struct {
...
type SafeMaskingPolicyObservation struct {
...
type SafeMaskingPolicyParameters struct {
...
// SafeMaskingPolicySpec defines the desired state of SafeMaskingPolicy
type SafeMaskingPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeMaskingPolicyParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeMaskingPolicyInitParameters `json:"initProvider,omitempty"`
}

// SafeMaskingPolicyStatus defines the observed state of SafeMaskingPolicy.
type SafeMaskingPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeMaskingPolicyObservation `json:"atProvider,omitempty"`
}
...
// SafeMaskingPolicy is the Schema for the SafeMaskingPolicys API. Provides the Masking Policy resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeMaskingPolicy struct {
	...
	Spec   SafeMaskingPolicySpec   `json:"spec"`
	Status SafeMaskingPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeMaskingPolicyList contains a list of SafeMaskingPolicys
type SafeMaskingPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeMaskingPolicy `json:"items"`
}

// Repository type metadata.
var (
	SafeMaskingPolicy_Kind             = "SafeMaskingPolicy"
	SafeMaskingPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeMaskingPolicy_Kind}.String()
	SafeMaskingPolicy_KindAPIVersion   = SafeMaskingPolicy_Kind + "." + CRDGroupVersion.String()
	SafeMaskingPolicy_GroupVersionKind = CRDGroupVersion.WithKind(SafeMaskingPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeMaskingPolicy{}, &SafeMaskingPolicyList{})
}
