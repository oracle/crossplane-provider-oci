...
type SafeSqlCollectionInitParameters struct {
...
type SafeSqlCollectionObservation struct {
...
type SafeSqlCollectionParameters struct {
...
// SafeSqlCollectionSpec defines the desired state of SafeSqlCollection
type SafeSqlCollectionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeSqlCollectionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeSqlCollectionInitParameters `json:"initProvider,omitempty"`
}

// SafeSqlCollectionStatus defines the observed state of SafeSqlCollection.
type SafeSqlCollectionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeSqlCollectionObservation `json:"atProvider,omitempty"`
}
...
// SafeSqlCollection is the Schema for the SafeSqlCollections API. Provides the Sql Collection resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeSqlCollection struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SafeSqlCollectionSpec   `json:"spec"`
	Status            SafeSqlCollectionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeSqlCollectionList contains a list of SafeSqlCollections
type SafeSqlCollectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeSqlCollection `json:"items"`
}

// Repository type metadata.
var (
	SafeSqlCollection_Kind             = "SafeSqlCollection"
	SafeSqlCollection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeSqlCollection_Kind}.String()
	SafeSqlCollection_KindAPIVersion   = SafeSqlCollection_Kind + "." + CRDGroupVersion.String()
	SafeSqlCollection_GroupVersionKind = CRDGroupVersion.WithKind(SafeSqlCollection_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeSqlCollection{}, &SafeSqlCollectionList{})
}
