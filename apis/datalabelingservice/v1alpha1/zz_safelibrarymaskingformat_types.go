...
type SafeLibraryMaskingFormatInitParameters struct {
...
type SafeLibraryMaskingFormatObservation struct {
...
type SafeLibraryMaskingFormatParameters struct {
...
// SafeLibraryMaskingFormatSpec defines the desired state of SafeLibraryMaskingFormat
type SafeLibraryMaskingFormatSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeLibraryMaskingFormatParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeLibraryMaskingFormatInitParameters `json:"initProvider,omitempty"`
}

// SafeLibraryMaskingFormatStatus defines the observed state of SafeLibraryMaskingFormat.
type SafeLibraryMaskingFormatStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeLibraryMaskingFormatObservation `json:"atProvider,omitempty"`
}
...
// SafeLibraryMaskingFormat is the Schema for the SafeLibraryMaskingFormats API. Provides the Library Masking Format resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeLibraryMaskingFormat struct {
	...
	Spec   SafeLibraryMaskingFormatSpec   `json:"spec"`
	Status SafeLibraryMaskingFormatStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeLibraryMaskingFormatList contains a list of SafeLibraryMaskingFormats
type SafeLibraryMaskingFormatList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeLibraryMaskingFormat `json:"items"`
}

// Repository type metadata.
var (
	SafeLibraryMaskingFormat_Kind             = "SafeLibraryMaskingFormat"
	SafeLibraryMaskingFormat_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeLibraryMaskingFormat_Kind}.String()
	SafeLibraryMaskingFormat_KindAPIVersion   = SafeLibraryMaskingFormat_Kind + "." + CRDGroupVersion.String()
	SafeLibraryMaskingFormat_GroupVersionKind = CRDGroupVersion.WithKind(SafeLibraryMaskingFormat_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeLibraryMaskingFormat{}, &SafeLibraryMaskingFormatList{})
}
