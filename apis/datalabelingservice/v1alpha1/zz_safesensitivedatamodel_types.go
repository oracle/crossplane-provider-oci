...
type SafeSensitiveDataModelInitParameters struct {
	...
	TablesForDiscovery []SafeSensitiveDataModelTablesForDiscoveryInitParameters `json:"tablesForDiscovery,omitempty" tf:"tables_for_discovery,omitempty"`
...
type SafeSensitiveDataModelObservation struct {
	...
	// (Updatable) The data discovery jobs will scan the tables specified here, including both schemas and tables. For instance, the input could be in the format: [{schemaName: "HR", tableName: ["T1", "T2"]}, {schemaName:  "OE", tableName : ["T3", "T4"]}].
	TablesForDiscovery []SafeSensitiveDataModelTablesForDiscoveryObservation `json:"tablesForDiscovery,omitempty" tf:"tables_for_discovery,omitempty"`
...
type SafeSensitiveDataModelParameters struct {
	...
	// (Updatable) The data discovery jobs will scan the tables specified here, including both schemas and tables. For instance, the input could be in the format: [{schemaName: "HR", tableName: ["T1", "T2"]}, {schemaName:  "OE", tableName : ["T3", "T4"]}].
	// +kubebuilder:validation:Optional
	TablesForDiscovery []SafeSensitiveDataModelTablesForDiscoveryParameters `json:"tablesForDiscovery,omitempty" tf:"tables_for_discovery,omitempty"`
...
type SafeSensitiveDataModelTablesForDiscoveryInitParameters struct {
...
type SafeSensitiveDataModelTablesForDiscoveryObservation struct {
...
type SafeSensitiveDataModelTablesForDiscoveryParameters struct {
...
// SafeSensitiveDataModelSpec defines the desired state of SafeSensitiveDataModel
type SafeSensitiveDataModelSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeSensitiveDataModelParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeSensitiveDataModelInitParameters `json:"initProvider,omitempty"`
}

// SafeSensitiveDataModelStatus defines the observed state of SafeSensitiveDataModel.
type SafeSensitiveDataModelStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeSensitiveDataModelObservation `json:"atProvider,omitempty"`
}
...
// SafeSensitiveDataModel is the Schema for the SafeSensitiveDataModels API. Provides the Sensitive Data Model resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeSensitiveDataModel struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SafeSensitiveDataModelSpec   `json:"spec"`
	Status            SafeSensitiveDataModelStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeSensitiveDataModelList contains a list of SafeSensitiveDataModels
type SafeSensitiveDataModelList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeSensitiveDataModel `json:"items"`
}

// Repository type metadata.
var (
	SafeSensitiveDataModel_Kind             = "SafeSensitiveDataModel"
	SafeSensitiveDataModel_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeSensitiveDataModel_Kind}.String()
	SafeSensitiveDataModel_KindAPIVersion   = SafeSensitiveDataModel_Kind + "." + CRDGroupVersion.String()
	SafeSensitiveDataModel_GroupVersionKind = CRDGroupVersion.WithKind(SafeSensitiveDataModel_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeSensitiveDataModel{}, &SafeSensitiveDataModelList{})
}
