...
type SafeAuditProfileInitParameters struct {
...
type SafeAuditProfileObservation struct {
...
type SafeAuditProfileParameters struct {
...
// SafeAuditProfileSpec defines the desired state of SafeAuditProfile
type SafeAuditProfileSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeAuditProfileParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeAuditProfileInitParameters `json:"initProvider,omitempty"`
}

// SafeAuditProfileStatus defines the observed state of SafeAuditProfile.
type SafeAuditProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeAuditProfileObservation `json:"atProvider,omitempty"`
}
...
// SafeAuditProfile is the Schema for the SafeAuditProfiles API. Provides the Audit Profile resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeAuditProfile struct {
	...
	Spec   SafeAuditProfileSpec   `json:"spec"`
	Status SafeAuditProfileStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeAuditProfileList contains a list of SafeAuditProfiles
type SafeAuditProfileList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeAuditProfile `json:"items"`
}

// Repository type metadata.
var (
	SafeAuditProfile_Kind             = "SafeAuditProfile"
	SafeAuditProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeAuditProfile_Kind}.String()
	SafeAuditProfile_KindAPIVersion   = SafeAuditProfile_Kind + "." + CRDGroupVersion.String()
	SafeAuditProfile_GroupVersionKind = CRDGroupVersion.WithKind(SafeAuditProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeAuditProfile{}, &SafeAuditProfileList{})
}
