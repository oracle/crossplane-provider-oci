...
type SafeReportDefinitionInitParameters struct {
...
type SafeReportDefinitionObservation struct {
...
type SafeReportDefinitionParameters struct {
...
// SafeReportDefinitionSpec defines the desired state of SafeReportDefinition
type SafeReportDefinitionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeReportDefinitionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeReportDefinitionInitParameters `json:"initProvider,omitempty"`
}

// SafeReportDefinitionStatus defines the observed state of SafeReportDefinition.
type SafeReportDefinitionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeReportDefinitionObservation `json:"atProvider,omitempty"`
}
...
// SafeReportDefinition is the Schema for the SafeReportDefinitions API. Provides the Report Definition resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeReportDefinition struct {
	...
	Spec   SafeReportDefinitionSpec   `json:"spec"`
	Status SafeReportDefinitionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeReportDefinitionList contains a list of SafeReportDefinitions
type SafeReportDefinitionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeReportDefinition `json:"items"`
}

// Repository type metadata.
var (
	SafeReportDefinition_Kind             = "SafeReportDefinition"
	SafeReportDefinition_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeReportDefinition_Kind}.String()
	SafeReportDefinition_KindAPIVersion   = SafeReportDefinition_Kind + "." + CRDGroupVersion.String()
	SafeReportDefinition_GroupVersionKind = CRDGroupVersion.WithKind(SafeReportDefinition_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeReportDefinition{}, &SafeReportDefinitionList{})
}
