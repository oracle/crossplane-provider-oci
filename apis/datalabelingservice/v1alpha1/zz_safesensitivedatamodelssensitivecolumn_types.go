...
type SafeSensitiveDataModelsSensitiveColumnConfidenceLevelDetailsInitParameters struct {
}

type SafeSensitiveDataModelsSensitiveColumnConfidenceLevelDetailsObservation struct {
...
type SafeSensitiveDataModelsSensitiveColumnConfidenceLevelDetailsParameters struct {
}

type SafeSensitiveDataModelsSensitiveColumnInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/datalabelingservice/v1alpha1.SafeSensitiveDataModel
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
	SensitiveDataModelID *string `json:"sensitiveDataModelId,omitempty" tf:"sensitive_data_model_id,omitempty"`

	// Reference to a SafeSensitiveDataModel in datalabelingservice to populate sensitiveDataModelId.
	// +kubebuilder:validation:Optional
	SensitiveDataModelIDRef *v1.Reference `json:"sensitiveDataModelIdRef,omitempty" tf:"-"`

	// Selector for a SafeSensitiveDataModel in datalabelingservice to populate sensitiveDataModelId.
	// +kubebuilder:validation:Optional
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/datalabelingservice/v1alpha1.SafeSensitiveType
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
	SensitiveTypeID *string `json:"sensitiveTypeId,omitempty" tf:"sensitive_type_id,omitempty"`

	// Reference to a SafeSensitiveType in datalabelingservice to populate sensitiveTypeId.
	// +kubebuilder:validation:Optional
	SensitiveTypeIDRef *v1.Reference `json:"sensitiveTypeIdRef,omitempty" tf:"-"`

	// Selector for a SafeSensitiveType in datalabelingservice to populate sensitiveTypeId.
	// +kubebuilder:validation:Optional
...
type SafeSensitiveDataModelsSensitiveColumnObservation struct {
	...
	ConfidenceLevelDetails []SafeSensitiveDataModelsSensitiveColumnConfidenceLevelDetailsObservation `json:"confidenceLevelDetails,omitempty" tf:"confidence_level_details,omitempty"`
...
type SafeSensitiveDataModelsSensitiveColumnParameters struct {
...
// SafeSensitiveDataModelsSensitiveColumnSpec defines the desired state of SafeSensitiveDataModelsSensitiveColumn
type SafeSensitiveDataModelsSensitiveColumnSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeSensitiveDataModelsSensitiveColumnParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeSensitiveDataModelsSensitiveColumnInitParameters `json:"initProvider,omitempty"`
}

// SafeSensitiveDataModelsSensitiveColumnStatus defines the observed state of SafeSensitiveDataModelsSensitiveColumn.
type SafeSensitiveDataModelsSensitiveColumnStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeSensitiveDataModelsSensitiveColumnObservation `json:"atProvider,omitempty"`
}
...
// SafeSensitiveDataModelsSensitiveColumn is the Schema for the SafeSensitiveDataModelsSensitiveColumns API. Provides the Sensitive Data Models Sensitive Column resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeSensitiveDataModelsSensitiveColumn struct {
	...
	Spec   SafeSensitiveDataModelsSensitiveColumnSpec   `json:"spec"`
	Status SafeSensitiveDataModelsSensitiveColumnStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeSensitiveDataModelsSensitiveColumnList contains a list of SafeSensitiveDataModelsSensitiveColumns
type SafeSensitiveDataModelsSensitiveColumnList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeSensitiveDataModelsSensitiveColumn `json:"items"`
}

// Repository type metadata.
var (
	SafeSensitiveDataModelsSensitiveColumn_Kind             = "SafeSensitiveDataModelsSensitiveColumn"
	SafeSensitiveDataModelsSensitiveColumn_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeSensitiveDataModelsSensitiveColumn_Kind}.String()
	SafeSensitiveDataModelsSensitiveColumn_KindAPIVersion   = SafeSensitiveDataModelsSensitiveColumn_Kind + "." + CRDGroupVersion.String()
	SafeSensitiveDataModelsSensitiveColumn_GroupVersionKind = CRDGroupVersion.WithKind(SafeSensitiveDataModelsSensitiveColumn_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeSensitiveDataModelsSensitiveColumn{}, &SafeSensitiveDataModelsSensitiveColumnList{})
}
