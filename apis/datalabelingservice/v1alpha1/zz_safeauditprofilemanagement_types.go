...
type SafeAuditProfileManagementAuditTrailsInitParameters struct {
}

type SafeAuditProfileManagementAuditTrailsObservation struct {
...
type SafeAuditProfileManagementAuditTrailsParameters struct {
}

type SafeAuditProfileManagementInitParameters struct {
...
type SafeAuditProfileManagementObservation struct {
	...
	AuditTrails []SafeAuditProfileManagementAuditTrailsObservation `json:"auditTrails,omitempty" tf:"audit_trails,omitempty"`
...
type SafeAuditProfileManagementParameters struct {
...
// SafeAuditProfileManagementSpec defines the desired state of SafeAuditProfileManagement
type SafeAuditProfileManagementSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeAuditProfileManagementParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeAuditProfileManagementInitParameters `json:"initProvider,omitempty"`
}

// SafeAuditProfileManagementStatus defines the observed state of SafeAuditProfileManagement.
type SafeAuditProfileManagementStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeAuditProfileManagementObservation `json:"atProvider,omitempty"`
}
...
// SafeAuditProfileManagement is the Schema for the SafeAuditProfileManagements API. Provides the Audit Profile Management resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeAuditProfileManagement struct {
	...
	Spec   SafeAuditProfileManagementSpec   `json:"spec"`
	Status SafeAuditProfileManagementStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeAuditProfileManagementList contains a list of SafeAuditProfileManagements
type SafeAuditProfileManagementList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeAuditProfileManagement `json:"items"`
}

// Repository type metadata.
var (
	SafeAuditProfileManagement_Kind             = "SafeAuditProfileManagement"
	SafeAuditProfileManagement_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeAuditProfileManagement_Kind}.String()
	SafeAuditProfileManagement_KindAPIVersion   = SafeAuditProfileManagement_Kind + "." + CRDGroupVersion.String()
	SafeAuditProfileManagement_GroupVersionKind = CRDGroupVersion.WithKind(SafeAuditProfileManagement_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeAuditProfileManagement{}, &SafeAuditProfileManagementList{})
}
