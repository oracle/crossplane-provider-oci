...
type SafeDiscoveryJobInitParameters struct {
...
type SafeDiscoveryJobObservation struct {
...
type SafeDiscoveryJobParameters struct {
...
// SafeDiscoveryJobSpec defines the desired state of SafeDiscoveryJob
type SafeDiscoveryJobSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeDiscoveryJobParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeDiscoveryJobInitParameters `json:"initProvider,omitempty"`
}

// SafeDiscoveryJobStatus defines the observed state of SafeDiscoveryJob.
type SafeDiscoveryJobStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeDiscoveryJobObservation `json:"atProvider,omitempty"`
}
...
// SafeDiscoveryJob is the Schema for the SafeDiscoveryJobs API. Provides the Discovery Job resource in Oracle Cloud Infrastructure Data Safe service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type SafeDiscoveryJob struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              SafeDiscoveryJobSpec   `json:"spec"`
	Status            SafeDiscoveryJobStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeDiscoveryJobList contains a list of SafeDiscoveryJobs
type SafeDiscoveryJobList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeDiscoveryJob `json:"items"`
}

// Repository type metadata.
var (
	SafeDiscoveryJob_Kind             = "SafeDiscoveryJob"
	SafeDiscoveryJob_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeDiscoveryJob_Kind}.String()
	SafeDiscoveryJob_KindAPIVersion   = SafeDiscoveryJob_Kind + "." + CRDGroupVersion.String()
	SafeDiscoveryJob_GroupVersionKind = CRDGroupVersion.WithKind(SafeDiscoveryJob_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeDiscoveryJob{}, &SafeDiscoveryJobList{})
}
