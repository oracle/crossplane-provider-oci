...
type SafeDataSafePrivateEndpointInitParameters struct {
...
type SafeDataSafePrivateEndpointObservation struct {
...
type SafeDataSafePrivateEndpointParameters struct {
...
// SafeDataSafePrivateEndpointSpec defines the desired state of SafeDataSafePrivateEndpoint
type SafeDataSafePrivateEndpointSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeDataSafePrivateEndpointParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeDataSafePrivateEndpointInitParameters `json:"initProvider,omitempty"`
}

// SafeDataSafePrivateEndpointStatus defines the observed state of SafeDataSafePrivateEndpoint.
type SafeDataSafePrivateEndpointStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeDataSafePrivateEndpointObservation `json:"atProvider,omitempty"`
}
...
// SafeDataSafePrivateEndpoint is the Schema for the SafeDataSafePrivateEndpoints API. Provides the Data Safe Private Endpoint resource in Oracle Cloud Infrastructure Data Safe service
...
type SafeDataSafePrivateEndpoint struct {
	...
	Spec   SafeDataSafePrivateEndpointSpec   `json:"spec"`
	Status SafeDataSafePrivateEndpointStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeDataSafePrivateEndpointList contains a list of SafeDataSafePrivateEndpoints
type SafeDataSafePrivateEndpointList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeDataSafePrivateEndpoint `json:"items"`
}

// Repository type metadata.
var (
	SafeDataSafePrivateEndpoint_Kind             = "SafeDataSafePrivateEndpoint"
	SafeDataSafePrivateEndpoint_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeDataSafePrivateEndpoint_Kind}.String()
	SafeDataSafePrivateEndpoint_KindAPIVersion   = SafeDataSafePrivateEndpoint_Kind + "." + CRDGroupVersion.String()
	SafeDataSafePrivateEndpoint_GroupVersionKind = CRDGroupVersion.WithKind(SafeDataSafePrivateEndpoint_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeDataSafePrivateEndpoint{}, &SafeDataSafePrivateEndpointList{})
}
