...
type SafeUserAssessmentInitParameters struct {
...
type SafeUserAssessmentObservation struct {
...
type SafeUserAssessmentParameters struct {
...
// SafeUserAssessmentSpec defines the desired state of SafeUserAssessment
type SafeUserAssessmentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeUserAssessmentParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeUserAssessmentInitParameters `json:"initProvider,omitempty"`
}

// SafeUserAssessmentStatus defines the observed state of SafeUserAssessment.
type SafeUserAssessmentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeUserAssessmentObservation `json:"atProvider,omitempty"`
}
...
// SafeUserAssessment is the Schema for the SafeUserAssessments API. Provides the User Assessment resource in Oracle Cloud Infrastructure Data Safe service
...
type SafeUserAssessment struct {
	...
	Spec              SafeUserAssessmentSpec   `json:"spec"`
	Status            SafeUserAssessmentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeUserAssessmentList contains a list of SafeUserAssessments
type SafeUserAssessmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeUserAssessment `json:"items"`
}

// Repository type metadata.
var (
	SafeUserAssessment_Kind             = "SafeUserAssessment"
	SafeUserAssessment_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeUserAssessment_Kind}.String()
	SafeUserAssessment_KindAPIVersion   = SafeUserAssessment_Kind + "." + CRDGroupVersion.String()
	SafeUserAssessment_GroupVersionKind = CRDGroupVersion.WithKind(SafeUserAssessment_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeUserAssessment{}, &SafeUserAssessmentList{})
}
