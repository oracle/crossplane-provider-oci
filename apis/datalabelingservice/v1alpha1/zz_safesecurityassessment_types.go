...
type SafeSecurityAssessmentInitParameters struct {
	...
	// Reference to a SafeSecurityAssessment in datalabelingservice to populate baseSecurityAssessmentId.
	// +kubebuilder:validation:Optional
	BaseSecurityAssessmentIDRef *v1.Reference `json:"baseSecurityAssessmentIdRef,omitempty" tf:"-"`

	// Selector for a SafeSecurityAssessment in datalabelingservice to populate baseSecurityAssessmentId.
	// +kubebuilder:validation:Optional
...
type SafeSecurityAssessmentObservation struct {
...
type SafeSecurityAssessmentParameters struct {
...
// SafeSecurityAssessmentSpec defines the desired state of SafeSecurityAssessment
type SafeSecurityAssessmentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     SafeSecurityAssessmentParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider SafeSecurityAssessmentInitParameters `json:"initProvider,omitempty"`
}

// SafeSecurityAssessmentStatus defines the observed state of SafeSecurityAssessment.
type SafeSecurityAssessmentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        SafeSecurityAssessmentObservation `json:"atProvider,omitempty"`
}
...
// SafeSecurityAssessment is the Schema for the SafeSecurityAssessments API. Provides the Security Assessment resource in Oracle Cloud Infrastructure Data Safe service
...
type SafeSecurityAssessment struct {
	...
	Spec              SafeSecurityAssessmentSpec   `json:"spec"`
	Status            SafeSecurityAssessmentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SafeSecurityAssessmentList contains a list of SafeSecurityAssessments
type SafeSecurityAssessmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SafeSecurityAssessment `json:"items"`
}

// Repository type metadata.
var (
	SafeSecurityAssessment_Kind             = "SafeSecurityAssessment"
	SafeSecurityAssessment_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: SafeSecurityAssessment_Kind}.String()
	SafeSecurityAssessment_KindAPIVersion   = SafeSecurityAssessment_Kind + "." + CRDGroupVersion.String()
	SafeSecurityAssessment_GroupVersionKind = CRDGroupVersion.WithKind(SafeSecurityAssessment_Kind)
)

func init() {
	SchemeBuilder.Register(&SafeSecurityAssessment{}, &SafeSecurityAssessmentList{})
}
