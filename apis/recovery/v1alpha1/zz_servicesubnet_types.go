...
type ServiceSubnetInitParameters struct {
...
type ServiceSubnetObservation struct {
...
type ServiceSubnetParameters struct {
...
// ServiceSubnetSpec defines the desired state of ServiceSubnet
type ServiceSubnetSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ServiceSubnetParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ServiceSubnetInitParameters `json:"initProvider,omitempty"`
}

// ServiceSubnetStatus defines the observed state of ServiceSubnet.
type ServiceSubnetStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServiceSubnetObservation `json:"atProvider,omitempty"`
}
...
// ServiceSubnet is the Schema for the ServiceSubnets API. Provides the Recovery Service Subnet resource in Oracle Cloud Infrastructure Recovery service
...
type ServiceSubnet struct {
	...
	Spec   ServiceSubnetSpec   `json:"spec"`
	Status ServiceSubnetStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceSubnetList contains a list of ServiceSubnets
type ServiceSubnetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServiceSubnet `json:"items"`
}

// Repository type metadata.
var (
	ServiceSubnet_Kind             = "ServiceSubnet"
	ServiceSubnet_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceSubnet_Kind}.String()
	ServiceSubnet_KindAPIVersion   = ServiceSubnet_Kind + "." + CRDGroupVersion.String()
	ServiceSubnet_GroupVersionKind = CRDGroupVersion.WithKind(ServiceSubnet_Kind)
)

func init() {
	SchemeBuilder.Register(&ServiceSubnet{}, &ServiceSubnetList{})
}
