...
type ServiceAnnouncementSubscriptionInitParameters struct {
...
type ServiceAnnouncementSubscriptionObservation struct {
...
type ServiceAnnouncementSubscriptionParameters struct {
...
// ServiceAnnouncementSubscriptionSpec defines the desired state of ServiceAnnouncementSubscription
type ServiceAnnouncementSubscriptionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ServiceAnnouncementSubscriptionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ServiceAnnouncementSubscriptionInitParameters `json:"initProvider,omitempty"`
}

// ServiceAnnouncementSubscriptionStatus defines the observed state of ServiceAnnouncementSubscription.
type ServiceAnnouncementSubscriptionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServiceAnnouncementSubscriptionObservation `json:"atProvider,omitempty"`
}
...
// ServiceAnnouncementSubscription is the Schema for the ServiceAnnouncementSubscriptions API. Provides the Announcement Subscription resource in Oracle Cloud Infrastructure Announcements Service service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type ServiceAnnouncementSubscription struct {
	...
	Spec   ServiceAnnouncementSubscriptionSpec   `json:"spec"`
	Status ServiceAnnouncementSubscriptionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServiceAnnouncementSubscriptionList contains a list of ServiceAnnouncementSubscriptions
type ServiceAnnouncementSubscriptionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServiceAnnouncementSubscription `json:"items"`
}

// Repository type metadata.
var (
	ServiceAnnouncementSubscription_Kind             = "ServiceAnnouncementSubscription"
	ServiceAnnouncementSubscription_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServiceAnnouncementSubscription_Kind}.String()
	ServiceAnnouncementSubscription_KindAPIVersion   = ServiceAnnouncementSubscription_Kind + "." + CRDGroupVersion.String()
	ServiceAnnouncementSubscription_GroupVersionKind = CRDGroupVersion.WithKind(ServiceAnnouncementSubscription_Kind)
)

func init() {
	SchemeBuilder.Register(&ServiceAnnouncementSubscription{}, &ServiceAnnouncementSubscriptionList{})
}
