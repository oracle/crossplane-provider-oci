...
type ResourceAction struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.resourceActionId) || (has(self.initProvider) && has(self.initProvider.resourceActionId))",message="spec.forProvider.resourceActionId is a required parameter"
