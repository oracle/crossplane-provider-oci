...
type BridgeAssetInitParameters struct {
...
type BridgeAssetObservation struct {
...
type BridgeAssetParameters struct {
...
// BridgeAssetSpec defines the desired state of BridgeAsset
type BridgeAssetSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BridgeAssetParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BridgeAssetInitParameters `json:"initProvider,omitempty"`
}

// BridgeAssetStatus defines the observed state of BridgeAsset.
type BridgeAssetStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BridgeAssetObservation `json:"atProvider,omitempty"`
}
...
// BridgeAsset is the Schema for the BridgeAssets API. Provides the Asset resource in Oracle Cloud Infrastructure Cloud Bridge service
...
type BridgeAsset struct {
	...
	Spec   BridgeAssetSpec   `json:"spec"`
	Status BridgeAssetStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BridgeAssetList contains a list of BridgeAssets
type BridgeAssetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BridgeAsset `json:"items"`
}

// Repository type metadata.
var (
	BridgeAsset_Kind             = "BridgeAsset"
	BridgeAsset_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BridgeAsset_Kind}.String()
	BridgeAsset_KindAPIVersion   = BridgeAsset_Kind + "." + CRDGroupVersion.String()
	BridgeAsset_GroupVersionKind = CRDGroupVersion.WithKind(BridgeAsset_Kind)
)

func init() {
	SchemeBuilder.Register(&BridgeAsset{}, &BridgeAssetList{})
}
