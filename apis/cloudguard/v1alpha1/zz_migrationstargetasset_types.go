...
type MigrationsTargetAssetInitParameters struct {
...
type MigrationsTargetAssetObservation struct {
	...
	MigrationAsset []MigrationAssetObservation `json:"migrationAsset,omitempty" tf:"migration_asset,omitempty"`
...
type MigrationsTargetAssetParameters struct {
...
// MigrationsTargetAssetSpec defines the desired state of MigrationsTargetAsset
type MigrationsTargetAssetSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MigrationsTargetAssetParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MigrationsTargetAssetInitParameters `json:"initProvider,omitempty"`
}

// MigrationsTargetAssetStatus defines the observed state of MigrationsTargetAsset.
type MigrationsTargetAssetStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MigrationsTargetAssetObservation `json:"atProvider,omitempty"`
}
...
// MigrationsTargetAsset is the Schema for the MigrationsTargetAssets API. Provides the Target Asset resource in Oracle Cloud Infrastructure Cloud Migrations service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type MigrationsTargetAsset struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.migrationPlanId) || (has(self.initProvider) && has(self.initProvider.migrationPlanId))",message="spec.forProvider.migrationPlanId is a required parameter"
	...
	Spec   MigrationsTargetAssetSpec   `json:"spec"`
	Status MigrationsTargetAssetStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MigrationsTargetAssetList contains a list of MigrationsTargetAssets
type MigrationsTargetAssetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MigrationsTargetAsset `json:"items"`
}

// Repository type metadata.
var (
	MigrationsTargetAsset_Kind             = "MigrationsTargetAsset"
	MigrationsTargetAsset_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MigrationsTargetAsset_Kind}.String()
	MigrationsTargetAsset_KindAPIVersion   = MigrationsTargetAsset_Kind + "." + CRDGroupVersion.String()
	MigrationsTargetAsset_GroupVersionKind = CRDGroupVersion.WithKind(MigrationsTargetAsset_Kind)
)

func init() {
	SchemeBuilder.Register(&MigrationsTargetAsset{}, &MigrationsTargetAssetList{})
}
