...
type GateConnectionInitParameters struct {
	...
	// (Applicable when connection_type=AMAZON_S3 | AZURE_DATA_LAKE_STORAGE | MICROSOFT_FABRIC) (Updatable) Optional Microsoft Fabric service endpoint. Default value: https://onelake.dfs.fabric.microsoft.com
	...
	// (Applicable when connection_type=OCI_OBJECT_STORAGE | ORACLE_NOSQL | SNOWFLAKE) (Updatable) The OCID of the Secret that stores the password for the private key file. Note: When provided, 'privateKeyPassphrase' field must not be provided.
	...
	// (Applicable when connection_type=OCI_OBJECT_STORAGE | ORACLE_NOSQL) (Updatable) The fingerprint of the API Key of the user specified by the userId. See documentation: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingcredentials.htm
	...
	// (Applicable when connection_type=AMAZON_S3 | OCI_OBJECT_STORAGE | ORACLE_NOSQL) (Updatable) The name of the region. e.g.: us-ashburn-1 If the region is not provided, backend will default to the default region.
	...
	// (Applicable when connection_type=DB2) (Updatable) The OCID of the Secret where the keystash file is stored,  which contains the encrypted password to the key database file. Note: When provided, 'sslClientKeystash' field must not be provided.
	SSLClientKeystashSecretID *string `json:"sslClientKeystashSecretId,omitempty" tf:"ssl_client_keystash_secret_id,omitempty"`

	// (Applicable when connection_type=DB2) (Updatable) The base64 encoded keystash file which contains the encrypted password to the key database file. Deprecated: This field is deprecated and replaced by "sslClientKeystashSecretId". This field will be removed after February 15 2026.
	SSLClientKeystashSecretRef *v1.SecretKeySelector `json:"sslClientKeystashSecretRef,omitempty" tf:"-"`

	// (Applicable when connection_type=DB2) (Updatable) The OCID of the Secret where the keystore file stored,  which created at the client containing the server certificate / CA root certificate. Note: When provided, 'sslClientKeystoredb' field must not be provided.
	...
	// (Applicable when connection_type=DB2) (Updatable) The base64 encoded keystore file created at the client containing the server certificate / CA root certificate. Deprecated: This field is deprecated and replaced by "sslClientKeystoredbSecretId". This field will be removed after February 15 2026.
	...
	// (Applicable when connection_type=OCI_OBJECT_STORAGE | ORACLE_NOSQL) (Updatable) Indicates that the user intents to connect to the instance through resource principal.
	...
	// (Applicable when connection_type=OCI_OBJECT_STORAGE | ORACLE_NOSQL) (Updatable) The OCID of the related Oracle Cloud Infrastructure tenancy.
...
type GateConnectionObservation struct {
...
type GateConnectionParameters struct {
...
// GateConnectionSpec defines the desired state of GateConnection
type GateConnectionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GateConnectionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GateConnectionInitParameters `json:"initProvider,omitempty"`
}

// GateConnectionStatus defines the observed state of GateConnection.
type GateConnectionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GateConnectionObservation `json:"atProvider,omitempty"`
}
...
// GateConnection is the Schema for the GateConnections API. Provides the Connection resource in Oracle Cloud Infrastructure Golden Gate service
...
type GateConnection struct {
	...
	Spec   GateConnectionSpec   `json:"spec"`
	Status GateConnectionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GateConnectionList contains a list of GateConnections
type GateConnectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GateConnection `json:"items"`
}

// Repository type metadata.
var (
	GateConnection_Kind             = "GateConnection"
	GateConnection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GateConnection_Kind}.String()
	GateConnection_KindAPIVersion   = GateConnection_Kind + "." + CRDGroupVersion.String()
	GateConnection_GroupVersionKind = CRDGroupVersion.WithKind(GateConnection_Kind)
)

func init() {
	SchemeBuilder.Register(&GateConnection{}, &GateConnectionList{})
}
