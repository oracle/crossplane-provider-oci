...
type GateDeploymentIngressIpsInitParameters struct {
}

type GateDeploymentIngressIpsObservation struct {

	// A Private Endpoint IPv4 or IPv6 Address created in the customer's subnet.
	IngressIP *string `json:"ingressIp,omitempty" tf:"ingress_ip,omitempty"`
}

type GateDeploymentIngressIpsParameters struct {
}

type GateDeploymentInitParameters struct {
	...
	Locks []GateDeploymentLocksInitParameters `json:"locks,omitempty" tf:"locks,omitempty"`
	...
	// (Updatable) The target state for the deployment. Could be set to ACTIVE or INACTIVE. Setting value to INACTIVE will stop your deployment.
...
type GateDeploymentLocksInitParameters struct {
...
type GateDeploymentLocksObservation struct {
...
type GateDeploymentLocksParameters struct {
...
type GateDeploymentObservation struct {
	...
	IngressIps []GateDeploymentIngressIpsObservation `json:"ingressIps,omitempty" tf:"ingress_ips,omitempty"`
	...
	// Locks associated with this resource.
	Locks []GateDeploymentLocksObservation `json:"locks,omitempty" tf:"locks,omitempty"`
...
type GateDeploymentParameters struct {
	...
	// Locks associated with this resource.
	// +kubebuilder:validation:Optional
	Locks []GateDeploymentLocksParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
// GateDeploymentSpec defines the desired state of GateDeployment
type GateDeploymentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GateDeploymentParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GateDeploymentInitParameters `json:"initProvider,omitempty"`
}

// GateDeploymentStatus defines the observed state of GateDeployment.
type GateDeploymentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GateDeploymentObservation `json:"atProvider,omitempty"`
}
...
// GateDeployment is the Schema for the GateDeployments API. Provides the Deployment resource in Oracle Cloud Infrastructure Golden Gate service
...
type GateDeployment struct {
	...
	Spec   GateDeploymentSpec   `json:"spec"`
	Status GateDeploymentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GateDeploymentList contains a list of GateDeployments
type GateDeploymentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GateDeployment `json:"items"`
}

// Repository type metadata.
var (
	GateDeployment_Kind             = "GateDeployment"
	GateDeployment_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GateDeployment_Kind}.String()
	GateDeployment_KindAPIVersion   = GateDeployment_Kind + "." + CRDGroupVersion.String()
	GateDeployment_GroupVersionKind = CRDGroupVersion.WithKind(GateDeployment_Kind)
)

func init() {
	SchemeBuilder.Register(&GateDeployment{}, &GateDeploymentList{})
}
