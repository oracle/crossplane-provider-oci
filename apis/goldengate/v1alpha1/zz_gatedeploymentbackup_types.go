...
type GateDeploymentBackupInitParameters struct {
	...
	Locks []GateDeploymentBackupLocksInitParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
type GateDeploymentBackupLocksInitParameters struct {
...
type GateDeploymentBackupLocksObservation struct {
...
type GateDeploymentBackupLocksParameters struct {
...
type GateDeploymentBackupObservation struct {
	...
	// Locks associated with this resource.
	Locks []GateDeploymentBackupLocksObservation `json:"locks,omitempty" tf:"locks,omitempty"`
...
type GateDeploymentBackupParameters struct {
	...
	// Locks associated with this resource.
	// +kubebuilder:validation:Optional
	Locks []GateDeploymentBackupLocksParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
// GateDeploymentBackupSpec defines the desired state of GateDeploymentBackup
type GateDeploymentBackupSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GateDeploymentBackupParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GateDeploymentBackupInitParameters `json:"initProvider,omitempty"`
}

// GateDeploymentBackupStatus defines the observed state of GateDeploymentBackup.
type GateDeploymentBackupStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GateDeploymentBackupObservation `json:"atProvider,omitempty"`
}
...
// GateDeploymentBackup is the Schema for the GateDeploymentBackups API. Provides the Deployment Backup resource in Oracle Cloud Infrastructure Golden Gate service
...
type GateDeploymentBackup struct {
	...
	Spec   GateDeploymentBackupSpec   `json:"spec"`
	Status GateDeploymentBackupStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GateDeploymentBackupList contains a list of GateDeploymentBackups
type GateDeploymentBackupList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GateDeploymentBackup `json:"items"`
}

// Repository type metadata.
var (
	GateDeploymentBackup_Kind             = "GateDeploymentBackup"
	GateDeploymentBackup_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GateDeploymentBackup_Kind}.String()
	GateDeploymentBackup_KindAPIVersion   = GateDeploymentBackup_Kind + "." + CRDGroupVersion.String()
	GateDeploymentBackup_GroupVersionKind = CRDGroupVersion.WithKind(GateDeploymentBackup_Kind)
)

func init() {
	SchemeBuilder.Register(&GateDeploymentBackup{}, &GateDeploymentBackupList{})
}
