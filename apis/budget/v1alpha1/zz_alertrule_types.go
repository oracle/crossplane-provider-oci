...
type AlertRule struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.budgetId) || (has(self.initProvider) && has(self.initProvider.budgetId))",message="spec.forProvider.budgetId is a required parameter"
