...
type DocumentModelInitParameters struct {
...
type DocumentModelObservation struct {
...
type DocumentModelParameters struct {
...
// DocumentModelSpec defines the desired state of DocumentModel
type DocumentModelSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DocumentModelParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DocumentModelInitParameters `json:"initProvider,omitempty"`
}

// DocumentModelStatus defines the observed state of DocumentModel.
type DocumentModelStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DocumentModelObservation `json:"atProvider,omitempty"`
}
...
// DocumentModel is the Schema for the DocumentModels API. Provides the Model resource in Oracle Cloud Infrastructure Ai Document service
...
type DocumentModel struct {
	...
	Spec   DocumentModelSpec   `json:"spec"`
	Status DocumentModelStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DocumentModelList contains a list of DocumentModels
type DocumentModelList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DocumentModel `json:"items"`
}

// Repository type metadata.
var (
	DocumentModel_Kind             = "DocumentModel"
	DocumentModel_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DocumentModel_Kind}.String()
	DocumentModel_KindAPIVersion   = DocumentModel_Kind + "." + CRDGroupVersion.String()
	DocumentModel_GroupVersionKind = CRDGroupVersion.WithKind(DocumentModel_Kind)
)

func init() {
	SchemeBuilder.Register(&DocumentModel{}, &DocumentModelList{})
}
