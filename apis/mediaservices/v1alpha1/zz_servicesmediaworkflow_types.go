...
type ServicesMediaWorkflowInitParameters struct {
	...
	Locks []ServicesMediaWorkflowLocksInitParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
type ServicesMediaWorkflowLocksInitParameters struct {
...
type ServicesMediaWorkflowLocksObservation struct {
...
type ServicesMediaWorkflowLocksParameters struct {
...
type ServicesMediaWorkflowObservation struct {
	...
	// Locks associated with this resource.
	Locks []ServicesMediaWorkflowLocksObservation `json:"locks,omitempty" tf:"locks,omitempty"`
...
type ServicesMediaWorkflowParameters struct {
	...
	// Locks associated with this resource.
	// +kubebuilder:validation:Optional
	Locks []ServicesMediaWorkflowLocksParameters `json:"locks,omitempty" tf:"locks,omitempty"`
...
// ServicesMediaWorkflowSpec defines the desired state of ServicesMediaWorkflow
type ServicesMediaWorkflowSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ServicesMediaWorkflowParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ServicesMediaWorkflowInitParameters `json:"initProvider,omitempty"`
}

// ServicesMediaWorkflowStatus defines the observed state of ServicesMediaWorkflow.
type ServicesMediaWorkflowStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ServicesMediaWorkflowObservation `json:"atProvider,omitempty"`
}
...
// ServicesMediaWorkflow is the Schema for the ServicesMediaWorkflows API. Provides the Media Workflow resource in Oracle Cloud Infrastructure Media Services service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type ServicesMediaWorkflow struct {
	...
	Spec   ServicesMediaWorkflowSpec   `json:"spec"`
	Status ServicesMediaWorkflowStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ServicesMediaWorkflowList contains a list of ServicesMediaWorkflows
type ServicesMediaWorkflowList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ServicesMediaWorkflow `json:"items"`
}

// Repository type metadata.
var (
	ServicesMediaWorkflow_Kind             = "ServicesMediaWorkflow"
	ServicesMediaWorkflow_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ServicesMediaWorkflow_Kind}.String()
	ServicesMediaWorkflow_KindAPIVersion   = ServicesMediaWorkflow_Kind + "." + CRDGroupVersion.String()
	ServicesMediaWorkflow_GroupVersionKind = CRDGroupVersion.WithKind(ServicesMediaWorkflow_Kind)
)

func init() {
	SchemeBuilder.Register(&ServicesMediaWorkflow{}, &ServicesMediaWorkflowList{})
}
