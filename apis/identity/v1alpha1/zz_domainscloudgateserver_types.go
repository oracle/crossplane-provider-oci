...
type DomainsCloudGateServerCloudGateInitParameters struct {

	// (Updatable) The id of the owning Cloud Gate.
	Value *string `json:"value,omitempty" tf:"value,omitempty"`
}

type DomainsCloudGateServerCloudGateObservation struct {
...
type DomainsCloudGateServerCloudGateParameters struct {
...
type DomainsCloudGateServerIdcsCreatedByInitParameters struct {
}

type DomainsCloudGateServerIdcsCreatedByObservation struct {
...
type DomainsCloudGateServerIdcsCreatedByParameters struct {
}

type DomainsCloudGateServerIdcsLastModifiedByInitParameters struct {
}

type DomainsCloudGateServerIdcsLastModifiedByObservation struct {
...
type DomainsCloudGateServerIdcsLastModifiedByParameters struct {
}

type DomainsCloudGateServerInitParameters struct {
	...
	CloudGate []DomainsCloudGateServerCloudGateInitParameters `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	Tags []DomainsCloudGateServerTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsCloudGateServerMetaInitParameters struct {
}

type DomainsCloudGateServerMetaObservation struct {
...
type DomainsCloudGateServerMetaParameters struct {
}

type DomainsCloudGateServerObservation struct {
	...
	// (Updatable) Reference to owning Cloud Gate
	CloudGate []DomainsCloudGateServerCloudGateObservation `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	IdcsCreatedBy []DomainsCloudGateServerIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsCloudGateServerIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsCloudGateServerMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsCloudGateServerTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type DomainsCloudGateServerParameters struct {
	...
	// (Updatable) Reference to owning Cloud Gate
	// +kubebuilder:validation:Optional
	CloudGate []DomainsCloudGateServerCloudGateParameters `json:"cloudGate,omitempty" tf:"cloud_gate,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsCloudGateServerTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsCloudGateServerTagsInitParameters struct {
...
type DomainsCloudGateServerTagsObservation struct {
...
type DomainsCloudGateServerTagsParameters struct {
...
// DomainsCloudGateServerSpec defines the desired state of DomainsCloudGateServer
type DomainsCloudGateServerSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsCloudGateServerParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsCloudGateServerInitParameters `json:"initProvider,omitempty"`
}

// DomainsCloudGateServerStatus defines the observed state of DomainsCloudGateServer.
type DomainsCloudGateServerStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsCloudGateServerObservation `json:"atProvider,omitempty"`
}
...
// DomainsCloudGateServer is the Schema for the DomainsCloudGateServers API. Provides the Cloud Gate Server resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsCloudGateServer struct {
	...
	Spec   DomainsCloudGateServerSpec   `json:"spec"`
	Status DomainsCloudGateServerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsCloudGateServerList contains a list of DomainsCloudGateServers
type DomainsCloudGateServerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsCloudGateServer `json:"items"`
}

// Repository type metadata.
var (
	DomainsCloudGateServer_Kind             = "DomainsCloudGateServer"
	DomainsCloudGateServer_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsCloudGateServer_Kind}.String()
	DomainsCloudGateServer_KindAPIVersion   = DomainsCloudGateServer_Kind + "." + CRDGroupVersion.String()
	DomainsCloudGateServer_GroupVersionKind = CRDGroupVersion.WithKind(DomainsCloudGateServer_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsCloudGateServer{}, &DomainsCloudGateServerList{})
}
