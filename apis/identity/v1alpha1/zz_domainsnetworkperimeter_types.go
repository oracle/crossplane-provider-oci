...
type DomainsNetworkPerimeterIdcsCreatedByInitParameters struct {
}

type DomainsNetworkPerimeterIdcsCreatedByObservation struct {
...
type DomainsNetworkPerimeterIdcsCreatedByParameters struct {
}

type DomainsNetworkPerimeterIdcsLastModifiedByInitParameters struct {
}

type DomainsNetworkPerimeterIdcsLastModifiedByObservation struct {
...
type DomainsNetworkPerimeterIdcsLastModifiedByParameters struct {
}

type DomainsNetworkPerimeterInitParameters struct {
	...
	Tags []DomainsNetworkPerimeterTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsNetworkPerimeterMetaInitParameters struct {
}

type DomainsNetworkPerimeterMetaObservation struct {
...
type DomainsNetworkPerimeterMetaParameters struct {
}

type DomainsNetworkPerimeterObservation struct {
	...
	IdcsCreatedBy []DomainsNetworkPerimeterIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsNetworkPerimeterIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsNetworkPerimeterMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsNetworkPerimeterTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type DomainsNetworkPerimeterParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsNetworkPerimeterTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsNetworkPerimeterTagsInitParameters struct {
...
type DomainsNetworkPerimeterTagsObservation struct {
...
type DomainsNetworkPerimeterTagsParameters struct {
...
// DomainsNetworkPerimeterSpec defines the desired state of DomainsNetworkPerimeter
type DomainsNetworkPerimeterSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsNetworkPerimeterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsNetworkPerimeterInitParameters `json:"initProvider,omitempty"`
}

// DomainsNetworkPerimeterStatus defines the observed state of DomainsNetworkPerimeter.
type DomainsNetworkPerimeterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsNetworkPerimeterObservation `json:"atProvider,omitempty"`
}
...
// DomainsNetworkPerimeter is the Schema for the DomainsNetworkPerimeters API. Provides the Network Perimeter resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsNetworkPerimeter struct {
	...
	Spec   DomainsNetworkPerimeterSpec   `json:"spec"`
	Status DomainsNetworkPerimeterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsNetworkPerimeterList contains a list of DomainsNetworkPerimeters
type DomainsNetworkPerimeterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsNetworkPerimeter `json:"items"`
}

// Repository type metadata.
var (
	DomainsNetworkPerimeter_Kind             = "DomainsNetworkPerimeter"
	DomainsNetworkPerimeter_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsNetworkPerimeter_Kind}.String()
	DomainsNetworkPerimeter_KindAPIVersion   = DomainsNetworkPerimeter_Kind + "." + CRDGroupVersion.String()
	DomainsNetworkPerimeter_GroupVersionKind = CRDGroupVersion.WithKind(DomainsNetworkPerimeter_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsNetworkPerimeter{}, &DomainsNetworkPerimeterList{})
}
