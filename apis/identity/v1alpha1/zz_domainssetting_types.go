...
type DomainsSettingIdcsCreatedByInitParameters struct {
}

type DomainsSettingIdcsCreatedByObservation struct {
...
type DomainsSettingIdcsCreatedByParameters struct {
}

type DomainsSettingIdcsLastModifiedByInitParameters struct {
}

type DomainsSettingIdcsLastModifiedByObservation struct {
...
type DomainsSettingIdcsLastModifiedByParameters struct {
}

type DomainsSettingInitParameters struct {
	...
	Tags []DomainsSettingTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type DomainsSettingMetaInitParameters struct {
}

type DomainsSettingMetaObservation struct {
...
type DomainsSettingMetaParameters struct {
}

type DomainsSettingObservation struct {
	...
	IdcsCreatedBy []DomainsSettingIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsSettingIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsSettingMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsSettingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type DomainsSettingParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsSettingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type DomainsSettingTagsInitParameters struct {
...
type DomainsSettingTagsObservation struct {
...
type DomainsSettingTagsParameters struct {
...
// DomainsSettingSpec defines the desired state of DomainsSetting
type DomainsSettingSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsSettingParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsSettingInitParameters `json:"initProvider,omitempty"`
}

// DomainsSettingStatus defines the observed state of DomainsSetting.
type DomainsSettingStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsSettingObservation `json:"atProvider,omitempty"`
}
...
// DomainsSetting is the Schema for the DomainsSettings API. Provides the Setting resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsSetting struct {
	...
	Spec   DomainsSettingSpec   `json:"spec"`
	Status DomainsSettingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsSettingList contains a list of DomainsSettings
type DomainsSettingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsSetting `json:"items"`
}

// Repository type metadata.
var (
	DomainsSetting_Kind             = "DomainsSetting"
	DomainsSetting_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsSetting_Kind}.String()
	DomainsSetting_KindAPIVersion   = DomainsSetting_Kind + "." + CRDGroupVersion.String()
	DomainsSetting_GroupVersionKind = CRDGroupVersion.WithKind(DomainsSetting_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsSetting{}, &DomainsSettingList{})
}
