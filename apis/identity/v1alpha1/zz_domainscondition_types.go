...
type DomainsConditionIdcsCreatedByInitParameters struct {
}

type DomainsConditionIdcsCreatedByObservation struct {
...
type DomainsConditionIdcsCreatedByParameters struct {
}

type DomainsConditionIdcsLastModifiedByInitParameters struct {
}

type DomainsConditionIdcsLastModifiedByObservation struct {
...
type DomainsConditionIdcsLastModifiedByParameters struct {
}

type DomainsConditionInitParameters struct {
	...
	Tags []DomainsConditionTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsConditionMetaInitParameters struct {
}

type DomainsConditionMetaObservation struct {
...
type DomainsConditionMetaParameters struct {
}

type DomainsConditionObservation struct {
	...
	IdcsCreatedBy []DomainsConditionIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsConditionIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsConditionMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsConditionTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type DomainsConditionParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsConditionTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsConditionTagsInitParameters struct {
...
type DomainsConditionTagsObservation struct {
...
type DomainsConditionTagsParameters struct {
...
// DomainsConditionSpec defines the desired state of DomainsCondition
type DomainsConditionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsConditionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsConditionInitParameters `json:"initProvider,omitempty"`
}

// DomainsConditionStatus defines the observed state of DomainsCondition.
type DomainsConditionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsConditionObservation `json:"atProvider,omitempty"`
}
...
// DomainsCondition is the Schema for the DomainsConditions API. Provides the Condition resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsCondition struct {
	...
	Spec   DomainsConditionSpec   `json:"spec"`
	Status DomainsConditionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsConditionList contains a list of DomainsConditions
type DomainsConditionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsCondition `json:"items"`
}

// Repository type metadata.
var (
	DomainsCondition_Kind             = "DomainsCondition"
	DomainsCondition_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsCondition_Kind}.String()
	DomainsCondition_KindAPIVersion   = DomainsCondition_Kind + "." + CRDGroupVersion.String()
	DomainsCondition_GroupVersionKind = CRDGroupVersion.WithKind(DomainsCondition_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsCondition{}, &DomainsConditionList{})
}
