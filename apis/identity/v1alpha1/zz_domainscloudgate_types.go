...
type DomainsCloudGateIdcsCreatedByInitParameters struct {
}

type DomainsCloudGateIdcsCreatedByObservation struct {
...
type DomainsCloudGateIdcsCreatedByParameters struct {
}

type DomainsCloudGateIdcsLastModifiedByInitParameters struct {
}

type DomainsCloudGateIdcsLastModifiedByObservation struct {
...
type DomainsCloudGateIdcsLastModifiedByParameters struct {
}

type DomainsCloudGateInitParameters struct {
	...
	Tags []DomainsCloudGateTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) The type of resource, User or App, that created this Resource
	Type *string `json:"type,omitempty" tf:"type,omitempty"`
}

type DomainsCloudGateMetaInitParameters struct {
}

type DomainsCloudGateMetaObservation struct {
...
type DomainsCloudGateMetaParameters struct {
}

type DomainsCloudGateObservation struct {
	...
	IdcsCreatedBy []DomainsCloudGateIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsCloudGateIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsCloudGateMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsCloudGateTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
...
type DomainsCloudGateParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsCloudGateTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
...
type DomainsCloudGateTagsInitParameters struct {
...
type DomainsCloudGateTagsObservation struct {
...
type DomainsCloudGateTagsParameters struct {
...
// DomainsCloudGateSpec defines the desired state of DomainsCloudGate
type DomainsCloudGateSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsCloudGateParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsCloudGateInitParameters `json:"initProvider,omitempty"`
}

// DomainsCloudGateStatus defines the observed state of DomainsCloudGate.
type DomainsCloudGateStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsCloudGateObservation `json:"atProvider,omitempty"`
}
...
// DomainsCloudGate is the Schema for the DomainsCloudGates API. Provides the Cloud Gate resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsCloudGate struct {
	...
	Spec   DomainsCloudGateSpec   `json:"spec"`
	Status DomainsCloudGateStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsCloudGateList contains a list of DomainsCloudGates
type DomainsCloudGateList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsCloudGate `json:"items"`
}

// Repository type metadata.
var (
	DomainsCloudGate_Kind             = "DomainsCloudGate"
	DomainsCloudGate_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsCloudGate_Kind}.String()
	DomainsCloudGate_KindAPIVersion   = DomainsCloudGate_Kind + "." + CRDGroupVersion.String()
	DomainsCloudGate_GroupVersionKind = CRDGroupVersion.WithKind(DomainsCloudGate_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsCloudGate{}, &DomainsCloudGateList{})
}
