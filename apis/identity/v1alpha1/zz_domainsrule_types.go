...
type DomainsRuleIdcsCreatedByInitParameters struct {
}

type DomainsRuleIdcsCreatedByObservation struct {
...
type DomainsRuleIdcsCreatedByParameters struct {
}

type DomainsRuleIdcsLastModifiedByInitParameters struct {
}

type DomainsRuleIdcsLastModifiedByObservation struct {
...
type DomainsRuleIdcsLastModifiedByParameters struct {
}

type DomainsRuleInitParameters struct {
	...
	PolicyType []DomainsRulePolicyTypeInitParameters `json:"policyType,omitempty" tf:"policy_type,omitempty"`
	...
	Tags []DomainsRuleTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsRuleMetaInitParameters struct {
}

type DomainsRuleMetaObservation struct {
...
type DomainsRuleMetaParameters struct {
}

type DomainsRuleObservation struct {
	...
	IdcsCreatedBy []DomainsRuleIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsRuleIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsRuleMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`

	// (Updatable) The OCID of the SCIM resource that represents the User or App who created this Resource
	Ocid *string `json:"ocid,omitempty" tf:"ocid,omitempty"`

	// (Updatable) PolicyType on which the policy is based
	PolicyType []DomainsRulePolicyTypeObservation `json:"policyType,omitempty" tf:"policy_type,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsRuleTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type DomainsRuleParameters struct {
	...
	// (Updatable) PolicyType on which the policy is based
	// +kubebuilder:validation:Optional
	PolicyType []DomainsRulePolicyTypeParameters `json:"policyType,omitempty" tf:"policy_type,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsRuleTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsRulePolicyTypeInitParameters struct {

	// (Updatable) Condition or ConditionGroup identifier.
	Value *string `json:"value,omitempty" tf:"value,omitempty"`
}

type DomainsRulePolicyTypeObservation struct {
...
type DomainsRulePolicyTypeParameters struct {
...
type DomainsRuleTagsInitParameters struct {
...
type DomainsRuleTagsObservation struct {
...
type DomainsRuleTagsParameters struct {
...
// DomainsRuleSpec defines the desired state of DomainsRule
type DomainsRuleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsRuleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsRuleInitParameters `json:"initProvider,omitempty"`
}

// DomainsRuleStatus defines the observed state of DomainsRule.
type DomainsRuleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsRuleObservation `json:"atProvider,omitempty"`
}
...
// DomainsRule is the Schema for the DomainsRules API. Provides the Rule resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsRule struct {
	...
	Spec   DomainsRuleSpec   `json:"spec"`
	Status DomainsRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsRuleList contains a list of DomainsRules
type DomainsRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsRule `json:"items"`
}

// Repository type metadata.
var (
	DomainsRule_Kind             = "DomainsRule"
	DomainsRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsRule_Kind}.String()
	DomainsRule_KindAPIVersion   = DomainsRule_Kind + "." + CRDGroupVersion.String()
	DomainsRule_GroupVersionKind = CRDGroupVersion.WithKind(DomainsRule_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsRule{}, &DomainsRuleList{})
}
