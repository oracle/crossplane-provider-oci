...
type DomainsPolicyIdcsCreatedByInitParameters struct {
}

type DomainsPolicyIdcsCreatedByObservation struct {
...
type DomainsPolicyIdcsCreatedByParameters struct {
}

type DomainsPolicyIdcsLastModifiedByInitParameters struct {
}

type DomainsPolicyIdcsLastModifiedByObservation struct {
...
type DomainsPolicyIdcsLastModifiedByParameters struct {
}

type DomainsPolicyInitParameters struct {
	...
	Tags []DomainsPolicyTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsPolicyMetaInitParameters struct {
}

type DomainsPolicyMetaObservation struct {
...
type DomainsPolicyMetaParameters struct {
}

type DomainsPolicyObservation struct {
	...
	IdcsCreatedBy []DomainsPolicyIdcsCreatedByObservation `json:"idcsCreatedBy,omitempty" tf:"idcs_created_by,omitempty"`

	// The basic endpoint for the identity domain
	IdcsEndpoint *string `json:"idcsEndpoint,omitempty" tf:"idcs_endpoint,omitempty"`

	// (Updatable) The User or App who modified the Resource
	IdcsLastModifiedBy []DomainsPolicyIdcsLastModifiedByObservation `json:"idcsLastModifiedBy,omitempty" tf:"idcs_last_modified_by,omitempty"`
	...
	Meta []DomainsPolicyMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// (Updatable) A list of tags on this resource.
	Tags []DomainsPolicyTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`

	// (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	TenancyOcid *string `json:"tenancyOcid,omitempty" tf:"tenancy_ocid,omitempty"`
}

type DomainsPolicyParameters struct {
	...
	// (Updatable) A list of tags on this resource.
	// +kubebuilder:validation:Optional
	Tags []DomainsPolicyTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}

type DomainsPolicyTagsInitParameters struct {
...
type DomainsPolicyTagsObservation struct {
...
type DomainsPolicyTagsParameters struct {
...
// DomainsPolicySpec defines the desired state of DomainsPolicy
type DomainsPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DomainsPolicyParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainsPolicyInitParameters `json:"initProvider,omitempty"`
}

// DomainsPolicyStatus defines the observed state of DomainsPolicy.
type DomainsPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainsPolicyObservation `json:"atProvider,omitempty"`
}
...
// DomainsPolicy is the Schema for the DomainsPolicys API. Provides the Policy resource in Oracle Cloud Infrastructure Identity Domains service
...
type DomainsPolicy struct {
	...
	Spec   DomainsPolicySpec   `json:"spec"`
	Status DomainsPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DomainsPolicyList contains a list of DomainsPolicys
type DomainsPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DomainsPolicy `json:"items"`
}

// Repository type metadata.
var (
	DomainsPolicy_Kind             = "DomainsPolicy"
	DomainsPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DomainsPolicy_Kind}.String()
	DomainsPolicy_KindAPIVersion   = DomainsPolicy_Kind + "." + CRDGroupVersion.String()
	DomainsPolicy_GroupVersionKind = CRDGroupVersion.WithKind(DomainsPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&DomainsPolicy{}, &DomainsPolicyList{})
}
