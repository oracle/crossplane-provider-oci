...
type DataflowApplicationInitParameters struct {
...
type DataflowApplicationObservation struct {
...
type DataflowApplicationParameters struct {
...
type DataflowApplicationSpec struct {
	...
	ForProvider     DataflowApplicationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DataflowApplicationInitParameters `json:"initProvider,omitempty"`
}

// DataflowApplicationStatus defines the observed state of DataflowApplication.
type DataflowApplicationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DataflowApplicationObservation `json:"atProvider,omitempty"`
}
...
// DataflowApplication is the Schema for the DataflowApplications API. Provides the Application resource in Oracle Cloud Infrastructure Data Flow service
...
type DataflowApplication struct {
	...
	Spec   DataflowApplicationSpec   `json:"spec"`
	Status DataflowApplicationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DataflowApplicationList contains a list of DataflowApplications
...
var (
	DataflowApplication_Kind             = "DataflowApplication"
	DataflowApplication_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DataflowApplication_Kind}.String()
	DataflowApplication_KindAPIVersion   = DataflowApplication_Kind + "." + CRDGroupVersion.String()
	DataflowApplication_GroupVersionKind = CRDGroupVersion.WithKind(DataflowApplication_Kind)
)
