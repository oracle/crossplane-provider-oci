...
type BigdataserviceAutoScalingConfigurationInitParameters struct {
...
type BigdataserviceAutoScalingConfigurationObservation struct {
...
type BigdataserviceAutoScalingConfigurationParameters struct {
...
// BigdataserviceAutoScalingConfigurationSpec defines the desired state of BigdataserviceAutoScalingConfiguration
type BigdataserviceAutoScalingConfigurationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     BigdataserviceAutoScalingConfigurationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BigdataserviceAutoScalingConfigurationInitParameters `json:"initProvider,omitempty"`
}

// BigdataserviceAutoScalingConfigurationStatus defines the observed state of BigdataserviceAutoScalingConfiguration.
type BigdataserviceAutoScalingConfigurationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        BigdataserviceAutoScalingConfigurationObservation `json:"atProvider,omitempty"`
}
...
// BigdataserviceAutoScalingConfiguration is the Schema for the BigdataserviceAutoScalingConfigurations API. Provides the Auto Scaling Configuration resource in Oracle Cloud Infrastructure Big Data Service service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type BigdataserviceAutoScalingConfiguration struct {
	...
	Spec   BigdataserviceAutoScalingConfigurationSpec   `json:"spec"`
	Status BigdataserviceAutoScalingConfigurationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BigdataserviceAutoScalingConfigurationList contains a list of BigdataserviceAutoScalingConfigurations
type BigdataserviceAutoScalingConfigurationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BigdataserviceAutoScalingConfiguration `json:"items"`
}

// Repository type metadata.
var (
	BigdataserviceAutoScalingConfiguration_Kind             = "BigdataserviceAutoScalingConfiguration"
	BigdataserviceAutoScalingConfiguration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BigdataserviceAutoScalingConfiguration_Kind}.String()
	BigdataserviceAutoScalingConfiguration_KindAPIVersion   = BigdataserviceAutoScalingConfiguration_Kind + "." + CRDGroupVersion.String()
	BigdataserviceAutoScalingConfiguration_GroupVersionKind = CRDGroupVersion.WithKind(BigdataserviceAutoScalingConfiguration_Kind)
)

func init() {
	SchemeBuilder.Register(&BigdataserviceAutoScalingConfiguration{}, &BigdataserviceAutoScalingConfigurationList{})
}
