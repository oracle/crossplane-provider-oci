...
type InstanceNodeBackupConfigurationInitParameters struct {
	...
	LevelTypeDetails []InstanceNodeBackupConfigurationLevelTypeDetailsInitParameters `json:"levelTypeDetails,omitempty" tf:"level_type_details,omitempty"`
...
type InstanceNodeBackupConfigurationLevelTypeDetailsInitParameters struct {
...
type InstanceNodeBackupConfigurationLevelTypeDetailsObservation struct {
...
type InstanceNodeBackupConfigurationLevelTypeDetailsParameters struct {
...
type InstanceNodeBackupConfigurationObservation struct {
	...
	// (Updatable) Details of the type of level used to trigger the creation of a new node backup configuration or node replacement configuration.
	LevelTypeDetails []InstanceNodeBackupConfigurationLevelTypeDetailsObservation `json:"levelTypeDetails,omitempty" tf:"level_type_details,omitempty"`
...
type InstanceNodeBackupConfigurationParameters struct {
	...
	// (Updatable) Details of the type of level used to trigger the creation of a new node backup configuration or node replacement configuration.
	// +kubebuilder:validation:Optional
	LevelTypeDetails []InstanceNodeBackupConfigurationLevelTypeDetailsParameters `json:"levelTypeDetails,omitempty" tf:"level_type_details,omitempty"`
...
// InstanceNodeBackupConfigurationSpec defines the desired state of InstanceNodeBackupConfiguration
type InstanceNodeBackupConfigurationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     InstanceNodeBackupConfigurationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider InstanceNodeBackupConfigurationInitParameters `json:"initProvider,omitempty"`
}

// InstanceNodeBackupConfigurationStatus defines the observed state of InstanceNodeBackupConfiguration.
type InstanceNodeBackupConfigurationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        InstanceNodeBackupConfigurationObservation `json:"atProvider,omitempty"`
}
...
// InstanceNodeBackupConfiguration is the Schema for the InstanceNodeBackupConfigurations API. Provides the Bds Instance Node Backup Configuration resource in Oracle Cloud Infrastructure Big Data Service service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type InstanceNodeBackupConfiguration struct {
	...
	Spec   InstanceNodeBackupConfigurationSpec   `json:"spec"`
	Status InstanceNodeBackupConfigurationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// InstanceNodeBackupConfigurationList contains a list of InstanceNodeBackupConfigurations
type InstanceNodeBackupConfigurationList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []InstanceNodeBackupConfiguration `json:"items"`
}

// Repository type metadata.
var (
	InstanceNodeBackupConfiguration_Kind             = "InstanceNodeBackupConfiguration"
	InstanceNodeBackupConfiguration_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: InstanceNodeBackupConfiguration_Kind}.String()
	InstanceNodeBackupConfiguration_KindAPIVersion   = InstanceNodeBackupConfiguration_Kind + "." + CRDGroupVersion.String()
	InstanceNodeBackupConfiguration_GroupVersionKind = CRDGroupVersion.WithKind(InstanceNodeBackupConfiguration_Kind)
)

func init() {
	SchemeBuilder.Register(&InstanceNodeBackupConfiguration{}, &InstanceNodeBackupConfigurationList{})
}
