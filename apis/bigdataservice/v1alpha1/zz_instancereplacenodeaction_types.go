...
type InstanceReplaceNodeActionInitParameters struct {
...
type InstanceReplaceNodeActionObservation struct {
...
type InstanceReplaceNodeActionParameters struct {
...
// InstanceReplaceNodeActionSpec defines the desired state of InstanceReplaceNodeAction
type InstanceReplaceNodeActionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     InstanceReplaceNodeActionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider InstanceReplaceNodeActionInitParameters `json:"initProvider,omitempty"`
}

// InstanceReplaceNodeActionStatus defines the observed state of InstanceReplaceNodeAction.
type InstanceReplaceNodeActionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        InstanceReplaceNodeActionObservation `json:"atProvider,omitempty"`
}
...
// InstanceReplaceNodeAction is the Schema for the InstanceReplaceNodeActions API. Provides the Bds Instance Node Replace Action  resource in Oracle Cloud Infrastructure Big Data Service service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type InstanceReplaceNodeAction struct {
	...
	Spec   InstanceReplaceNodeActionSpec   `json:"spec"`
	Status InstanceReplaceNodeActionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// InstanceReplaceNodeActionList contains a list of InstanceReplaceNodeActions
type InstanceReplaceNodeActionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []InstanceReplaceNodeAction `json:"items"`
}

// Repository type metadata.
var (
	InstanceReplaceNodeAction_Kind             = "InstanceReplaceNodeAction"
	InstanceReplaceNodeAction_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: InstanceReplaceNodeAction_Kind}.String()
	InstanceReplaceNodeAction_KindAPIVersion   = InstanceReplaceNodeAction_Kind + "." + CRDGroupVersion.String()
	InstanceReplaceNodeAction_GroupVersionKind = CRDGroupVersion.WithKind(InstanceReplaceNodeAction_Kind)
)

func init() {
	SchemeBuilder.Register(&InstanceReplaceNodeAction{}, &InstanceReplaceNodeActionList{})
}
