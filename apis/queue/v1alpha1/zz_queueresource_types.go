...
type QueueResourceInitParameters struct {
...
type QueueResourceObservation struct {
...
type QueueResourceParameters struct {
...
// QueueResourceSpec defines the desired state of QueueResource
type QueueResourceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     QueueResourceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider QueueResourceInitParameters `json:"initProvider,omitempty"`
}

// QueueResourceStatus defines the observed state of QueueResource.
type QueueResourceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        QueueResourceObservation `json:"atProvider,omitempty"`
}
...
// QueueResource is the Schema for the QueueResources API. Provides the Queue resource in Oracle Cloud Infrastructure Queue service
...
type QueueResource struct {
	...
	Spec   QueueResourceSpec   `json:"spec"`
	Status QueueResourceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// QueueResourceList contains a list of QueueResources
type QueueResourceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []QueueResource `json:"items"`
}

// Repository type metadata.
var (
	QueueResource_Kind             = "QueueResource"
	QueueResource_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: QueueResource_Kind}.String()
	QueueResource_KindAPIVersion   = QueueResource_Kind + "." + CRDGroupVersion.String()
	QueueResource_GroupVersionKind = CRDGroupVersion.WithKind(QueueResource_Kind)
)

func init() {
	SchemeBuilder.Register(&QueueResource{}, &QueueResourceList{})
}
