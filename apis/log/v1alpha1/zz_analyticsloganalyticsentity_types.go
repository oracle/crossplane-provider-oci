...
type AnalyticsLogAnalyticsEntityInitParameters struct {
...
type AnalyticsLogAnalyticsEntityObservation struct {
...
type AnalyticsLogAnalyticsEntityParameters struct {
...
// AnalyticsLogAnalyticsEntitySpec defines the desired state of AnalyticsLogAnalyticsEntity
type AnalyticsLogAnalyticsEntitySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AnalyticsLogAnalyticsEntityParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AnalyticsLogAnalyticsEntityInitParameters `json:"initProvider,omitempty"`
}

// AnalyticsLogAnalyticsEntityStatus defines the observed state of AnalyticsLogAnalyticsEntity.
type AnalyticsLogAnalyticsEntityStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AnalyticsLogAnalyticsEntityObservation `json:"atProvider,omitempty"`
}
...
// AnalyticsLogAnalyticsEntity is the Schema for the AnalyticsLogAnalyticsEntitys API. Provides the Log Analytics Entity resource in Oracle Cloud Infrastructure Log Analytics service
...
type AnalyticsLogAnalyticsEntity struct {
	...
	Spec   AnalyticsLogAnalyticsEntitySpec   `json:"spec"`
	Status AnalyticsLogAnalyticsEntityStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AnalyticsLogAnalyticsEntityList contains a list of AnalyticsLogAnalyticsEntitys
type AnalyticsLogAnalyticsEntityList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AnalyticsLogAnalyticsEntity `json:"items"`
}

// Repository type metadata.
var (
	AnalyticsLogAnalyticsEntity_Kind             = "AnalyticsLogAnalyticsEntity"
	AnalyticsLogAnalyticsEntity_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AnalyticsLogAnalyticsEntity_Kind}.String()
	AnalyticsLogAnalyticsEntity_KindAPIVersion   = AnalyticsLogAnalyticsEntity_Kind + "." + CRDGroupVersion.String()
	AnalyticsLogAnalyticsEntity_GroupVersionKind = CRDGroupVersion.WithKind(AnalyticsLogAnalyticsEntity_Kind)
)

func init() {
	SchemeBuilder.Register(&AnalyticsLogAnalyticsEntity{}, &AnalyticsLogAnalyticsEntityList{})
}
