...
type AnalyticsNamespaceIngestTimeRuleInitParameters struct {
...
type AnalyticsNamespaceIngestTimeRuleObservation struct {
...
type AnalyticsNamespaceIngestTimeRuleParameters struct {
...
// AnalyticsNamespaceIngestTimeRuleSpec defines the desired state of AnalyticsNamespaceIngestTimeRule
type AnalyticsNamespaceIngestTimeRuleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AnalyticsNamespaceIngestTimeRuleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AnalyticsNamespaceIngestTimeRuleInitParameters `json:"initProvider,omitempty"`
}

// AnalyticsNamespaceIngestTimeRuleStatus defines the observed state of AnalyticsNamespaceIngestTimeRule.
type AnalyticsNamespaceIngestTimeRuleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AnalyticsNamespaceIngestTimeRuleObservation `json:"atProvider,omitempty"`
}
...
// AnalyticsNamespaceIngestTimeRule is the Schema for the AnalyticsNamespaceIngestTimeRules API. Provides the Namespace Ingest Time Rule resource in Oracle Cloud Infrastructure Log Analytics service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type AnalyticsNamespaceIngestTimeRule struct {
	...
	Spec   AnalyticsNamespaceIngestTimeRuleSpec   `json:"spec"`
	Status AnalyticsNamespaceIngestTimeRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AnalyticsNamespaceIngestTimeRuleList contains a list of AnalyticsNamespaceIngestTimeRules
type AnalyticsNamespaceIngestTimeRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AnalyticsNamespaceIngestTimeRule `json:"items"`
}

// Repository type metadata.
var (
	AnalyticsNamespaceIngestTimeRule_Kind             = "AnalyticsNamespaceIngestTimeRule"
	AnalyticsNamespaceIngestTimeRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AnalyticsNamespaceIngestTimeRule_Kind}.String()
	AnalyticsNamespaceIngestTimeRule_KindAPIVersion   = AnalyticsNamespaceIngestTimeRule_Kind + "." + CRDGroupVersion.String()
	AnalyticsNamespaceIngestTimeRule_GroupVersionKind = CRDGroupVersion.WithKind(AnalyticsNamespaceIngestTimeRule_Kind)
)

func init() {
	SchemeBuilder.Register(&AnalyticsNamespaceIngestTimeRule{}, &AnalyticsNamespaceIngestTimeRuleList{})
}
