...
type AnalyticsLogAnalyticsObjectCollectionRuleInitParameters struct {
...
type AnalyticsLogAnalyticsObjectCollectionRuleObservation struct {
...
type AnalyticsLogAnalyticsObjectCollectionRuleParameters struct {
...
// AnalyticsLogAnalyticsObjectCollectionRuleSpec defines the desired state of AnalyticsLogAnalyticsObjectCollectionRule
type AnalyticsLogAnalyticsObjectCollectionRuleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AnalyticsLogAnalyticsObjectCollectionRuleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AnalyticsLogAnalyticsObjectCollectionRuleInitParameters `json:"initProvider,omitempty"`
}

// AnalyticsLogAnalyticsObjectCollectionRuleStatus defines the observed state of AnalyticsLogAnalyticsObjectCollectionRule.
type AnalyticsLogAnalyticsObjectCollectionRuleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AnalyticsLogAnalyticsObjectCollectionRuleObservation `json:"atProvider,omitempty"`
}
...
// AnalyticsLogAnalyticsObjectCollectionRule is the Schema for the AnalyticsLogAnalyticsObjectCollectionRules API. Provides the Log Analytics Object Collection Rule resource in Oracle Cloud Infrastructure Log Analytics service
...
type AnalyticsLogAnalyticsObjectCollectionRule struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.osBucketName) || (has(self.initProvider) && has(self.initProvider.osBucketName))",message="spec.forProvider.osBucketName is a required parameter"
	...
	Spec   AnalyticsLogAnalyticsObjectCollectionRuleSpec   `json:"spec"`
	Status AnalyticsLogAnalyticsObjectCollectionRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AnalyticsLogAnalyticsObjectCollectionRuleList contains a list of AnalyticsLogAnalyticsObjectCollectionRules
type AnalyticsLogAnalyticsObjectCollectionRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AnalyticsLogAnalyticsObjectCollectionRule `json:"items"`
}

// Repository type metadata.
var (
	AnalyticsLogAnalyticsObjectCollectionRule_Kind             = "AnalyticsLogAnalyticsObjectCollectionRule"
	AnalyticsLogAnalyticsObjectCollectionRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AnalyticsLogAnalyticsObjectCollectionRule_Kind}.String()
	AnalyticsLogAnalyticsObjectCollectionRule_KindAPIVersion   = AnalyticsLogAnalyticsObjectCollectionRule_Kind + "." + CRDGroupVersion.String()
	AnalyticsLogAnalyticsObjectCollectionRule_GroupVersionKind = CRDGroupVersion.WithKind(AnalyticsLogAnalyticsObjectCollectionRule_Kind)
)

func init() {
	SchemeBuilder.Register(&AnalyticsLogAnalyticsObjectCollectionRule{}, &AnalyticsLogAnalyticsObjectCollectionRuleList{})
}
