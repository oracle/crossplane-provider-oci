...
type ExternalExadataStorageGridInitParameters struct {
...
type ExternalExadataStorageGridObservation struct {
...
type ExternalExadataStorageGridParameters struct {
...
// ExternalExadataStorageGridSpec defines the desired state of ExternalExadataStorageGrid
type ExternalExadataStorageGridSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalExadataStorageGridParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalExadataStorageGridInitParameters `json:"initProvider,omitempty"`
}

// ExternalExadataStorageGridStatus defines the observed state of ExternalExadataStorageGrid.
type ExternalExadataStorageGridStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalExadataStorageGridObservation `json:"atProvider,omitempty"`
}
...
// ExternalExadataStorageGrid is the Schema for the ExternalExadataStorageGrids API. Provides the External Exadata Storage Grid resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalExadataStorageGrid struct {
	...
	Spec   ExternalExadataStorageGridSpec   `json:"spec"`
	Status ExternalExadataStorageGridStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalExadataStorageGridList contains a list of ExternalExadataStorageGrids
type ExternalExadataStorageGridList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalExadataStorageGrid `json:"items"`
}

// Repository type metadata.
var (
	ExternalExadataStorageGrid_Kind             = "ExternalExadataStorageGrid"
	ExternalExadataStorageGrid_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalExadataStorageGrid_Kind}.String()
	ExternalExadataStorageGrid_KindAPIVersion   = ExternalExadataStorageGrid_Kind + "." + CRDGroupVersion.String()
	ExternalExadataStorageGrid_GroupVersionKind = CRDGroupVersion.WithKind(ExternalExadataStorageGrid_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalExadataStorageGrid{}, &ExternalExadataStorageGridList{})
}
