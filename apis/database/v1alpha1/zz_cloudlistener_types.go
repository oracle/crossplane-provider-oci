...
type CloudListenerEndpointsInitParameters struct {
}

type CloudListenerEndpointsObservation struct {
...
type CloudListenerEndpointsParameters struct {
}

type CloudListenerInitParameters struct {
...
type CloudListenerObservation struct {
	...
	Endpoints []CloudListenerEndpointsObservation `json:"endpoints,omitempty" tf:"endpoints,omitempty"`
	...
	ServicedDatabases []CloudListenerServicedDatabasesObservation `json:"servicedDatabases,omitempty" tf:"serviced_databases,omitempty"`
...
type CloudListenerParameters struct {
...
type CloudListenerServicedDatabasesInitParameters struct {
}

type CloudListenerServicedDatabasesObservation struct {
...
type CloudListenerServicedDatabasesParameters struct {
}
...
type CloudListenerSpec struct {
	...
	ForProvider     CloudListenerParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudListenerInitParameters `json:"initProvider,omitempty"`
}

// CloudListenerStatus defines the observed state of CloudListener.
type CloudListenerStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudListenerObservation `json:"atProvider,omitempty"`
}
...
// CloudListener is the Schema for the CloudListeners API. Provides the Cloud Listener resource in Oracle Cloud Infrastructure Database Management service
...
type CloudListener struct {
	...
	Spec   CloudListenerSpec   `json:"spec"`
	Status CloudListenerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudListenerList contains a list of CloudListeners
...
var (
	CloudListener_Kind             = "CloudListener"
	CloudListener_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudListener_Kind}.String()
	CloudListener_KindAPIVersion   = CloudListener_Kind + "." + CRDGroupVersion.String()
	CloudListener_GroupVersionKind = CRDGroupVersion.WithKind(CloudListener_Kind)
)
