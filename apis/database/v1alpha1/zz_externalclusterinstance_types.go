...
type ExternalClusterInstanceInitParameters struct {
...
type ExternalClusterInstanceObservation struct {
...
type ExternalClusterInstanceParameters struct {
...
// ExternalClusterInstanceSpec defines the desired state of ExternalClusterInstance
type ExternalClusterInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalClusterInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalClusterInstanceInitParameters `json:"initProvider,omitempty"`
}

// ExternalClusterInstanceStatus defines the observed state of ExternalClusterInstance.
type ExternalClusterInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalClusterInstanceObservation `json:"atProvider,omitempty"`
}
...
// ExternalClusterInstance is the Schema for the ExternalClusterInstances API. Provides the External Cluster Instance resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalClusterInstance struct {
	...
	Spec   ExternalClusterInstanceSpec   `json:"spec"`
	Status ExternalClusterInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalClusterInstanceList contains a list of ExternalClusterInstances
type ExternalClusterInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalClusterInstance `json:"items"`
}

// Repository type metadata.
var (
	ExternalClusterInstance_Kind             = "ExternalClusterInstance"
	ExternalClusterInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalClusterInstance_Kind}.String()
	ExternalClusterInstance_KindAPIVersion   = ExternalClusterInstance_Kind + "." + CRDGroupVersion.String()
	ExternalClusterInstance_GroupVersionKind = CRDGroupVersion.WithKind(ExternalClusterInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalClusterInstance{}, &ExternalClusterInstanceList{})
}
