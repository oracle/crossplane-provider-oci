...
type ManagedDatabaseInitParameters struct {
...
type ManagedDatabaseSpec struct {
	...
	// autoscaler.
	InitProvider ManagedDatabaseInitParameters `json:"initProvider,omitempty"`
}
...
// ManagedDatabase is the Schema for the ManagedDatabases API. Provides the Managed Database resource in Oracle Cloud Infrastructure Database Management service
