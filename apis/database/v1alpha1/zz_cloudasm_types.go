...
type CloudAsmInitParameters struct {
...
type CloudAsmObservation struct {
...
type CloudAsmParameters struct {
...
// CloudAsmSpec defines the desired state of CloudAsm
type CloudAsmSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CloudAsmParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudAsmInitParameters `json:"initProvider,omitempty"`
}

// CloudAsmStatus defines the observed state of CloudAsm.
type CloudAsmStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudAsmObservation `json:"atProvider,omitempty"`
}
...
// CloudAsm is the Schema for the CloudAsms API. Provides the Cloud Asm resource in Oracle Cloud Infrastructure Database Management service
...
type CloudAsm struct {
	...
	Spec   CloudAsmSpec   `json:"spec"`
	Status CloudAsmStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudAsmList contains a list of CloudAsms
type CloudAsmList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudAsm `json:"items"`
}

// Repository type metadata.
var (
	CloudAsm_Kind             = "CloudAsm"
	CloudAsm_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudAsm_Kind}.String()
	CloudAsm_KindAPIVersion   = CloudAsm_Kind + "." + CRDGroupVersion.String()
	CloudAsm_GroupVersionKind = CRDGroupVersion.WithKind(CloudAsm_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudAsm{}, &CloudAsmList{})
}
