...
type ExternalAsmInitParameters struct {
...
type ExternalAsmObservation struct {
	...
	ServicedDatabases []ExternalAsmServicedDatabasesObservation `json:"servicedDatabases,omitempty" tf:"serviced_databases,omitempty"`
...
type ExternalAsmParameters struct {
...
type ExternalAsmServicedDatabasesInitParameters struct {
}

type ExternalAsmServicedDatabasesObservation struct {
...
type ExternalAsmServicedDatabasesParameters struct {
}

// ExternalAsmSpec defines the desired state of ExternalAsm
type ExternalAsmSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalAsmParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalAsmInitParameters `json:"initProvider,omitempty"`
}

// ExternalAsmStatus defines the observed state of ExternalAsm.
type ExternalAsmStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalAsmObservation `json:"atProvider,omitempty"`
}
...
// ExternalAsm is the Schema for the ExternalAsms API. Provides the External Asm resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalAsm struct {
	...
	Spec   ExternalAsmSpec   `json:"spec"`
	Status ExternalAsmStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalAsmList contains a list of ExternalAsms
type ExternalAsmList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalAsm `json:"items"`
}

// Repository type metadata.
var (
	ExternalAsm_Kind             = "ExternalAsm"
	ExternalAsm_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalAsm_Kind}.String()
	ExternalAsm_KindAPIVersion   = ExternalAsm_Kind + "." + CRDGroupVersion.String()
	ExternalAsm_GroupVersionKind = CRDGroupVersion.WithKind(ExternalAsm_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalAsm{}, &ExternalAsmList{})
}
