...
type CloudClusterInitParameters struct {
...
type CloudClusterObservation struct {
...
type CloudClusterParameters struct {
...
type CloudClusterSpec struct {
	...
	ForProvider     CloudClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudClusterInitParameters `json:"initProvider,omitempty"`
}

// CloudClusterStatus defines the observed state of CloudCluster.
type CloudClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudClusterObservation `json:"atProvider,omitempty"`
}
...
// CloudCluster is the Schema for the CloudClusters API. Provides the Cloud Cluster resource in Oracle Cloud Infrastructure Database Management service
...
type CloudCluster struct {
	...
	Spec   CloudClusterSpec   `json:"spec"`
	Status CloudClusterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudClusterList contains a list of CloudClusters
...
var (
	CloudCluster_Kind             = "CloudCluster"
	CloudCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudCluster_Kind}.String()
	CloudCluster_KindAPIVersion   = CloudCluster_Kind + "." + CRDGroupVersion.String()
	CloudCluster_GroupVersionKind = CRDGroupVersion.WithKind(CloudCluster_Kind)
)
