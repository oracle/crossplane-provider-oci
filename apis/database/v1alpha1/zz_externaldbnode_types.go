...
type ExternalDbNodeInitParameters struct {
...
type ExternalDbNodeObservation struct {
...
type ExternalDbNodeParameters struct {
...
// ExternalDbNodeSpec defines the desired state of ExternalDbNode
type ExternalDbNodeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalDbNodeParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalDbNodeInitParameters `json:"initProvider,omitempty"`
}

// ExternalDbNodeStatus defines the observed state of ExternalDbNode.
type ExternalDbNodeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalDbNodeObservation `json:"atProvider,omitempty"`
}
...
// ExternalDbNode is the Schema for the ExternalDbNodes API. Provides the External Db Node resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalDbNode struct {
	...
	Spec   ExternalDbNodeSpec   `json:"spec"`
	Status ExternalDbNodeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalDbNodeList contains a list of ExternalDbNodes
type ExternalDbNodeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalDbNode `json:"items"`
}

// Repository type metadata.
var (
	ExternalDbNode_Kind             = "ExternalDbNode"
	ExternalDbNode_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalDbNode_Kind}.String()
	ExternalDbNode_KindAPIVersion   = ExternalDbNode_Kind + "." + CRDGroupVersion.String()
	ExternalDbNode_GroupVersionKind = CRDGroupVersion.WithKind(ExternalDbNode_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalDbNode{}, &ExternalDbNodeList{})
}
