...
type CloudDbNodeInitParameters struct {
...
type CloudDbNodeObservation struct {
...
type CloudDbNodeParameters struct {
...
// CloudDbNodeSpec defines the desired state of CloudDbNode
type CloudDbNodeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CloudDbNodeParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudDbNodeInitParameters `json:"initProvider,omitempty"`
}

// CloudDbNodeStatus defines the observed state of CloudDbNode.
type CloudDbNodeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudDbNodeObservation `json:"atProvider,omitempty"`
}
...
// CloudDbNode is the Schema for the CloudDbNodes API. Provides the Cloud Db Node resource in Oracle Cloud Infrastructure Database Management service
...
type CloudDbNode struct {
	...
	Spec   CloudDbNodeSpec   `json:"spec"`
	Status CloudDbNodeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudDbNodeList contains a list of CloudDbNodes
type CloudDbNodeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudDbNode `json:"items"`
}

// Repository type metadata.
var (
	CloudDbNode_Kind             = "CloudDbNode"
	CloudDbNode_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudDbNode_Kind}.String()
	CloudDbNode_KindAPIVersion   = CloudDbNode_Kind + "." + CRDGroupVersion.String()
	CloudDbNode_GroupVersionKind = CRDGroupVersion.WithKind(CloudDbNode_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudDbNode{}, &CloudDbNodeList{})
}
