...
func (tr *ManagedDatabase) GetObservation() (map[string]any, error) {
...
func (tr *ManagedDatabase) SetObservation(obs map[string]any) error {
...
func (tr *ManagedDatabase) GetParameters() (map[string]any, error) {
...
func (tr *ManagedDatabase) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ManagedDatabase
func (tr *ManagedDatabase) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ManagedDatabase
func (tr *ManagedDatabase) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
