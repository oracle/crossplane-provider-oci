...
type CloudDbSystemConnectorInitParameters struct {
...
type CloudDbSystemConnectorObservation struct {
...
type CloudDbSystemConnectorParameters struct {
...
// CloudDbSystemConnectorSpec defines the desired state of CloudDbSystemConnector
type CloudDbSystemConnectorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CloudDbSystemConnectorParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudDbSystemConnectorInitParameters `json:"initProvider,omitempty"`
}

// CloudDbSystemConnectorStatus defines the observed state of CloudDbSystemConnector.
type CloudDbSystemConnectorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudDbSystemConnectorObservation `json:"atProvider,omitempty"`
}
...
// CloudDbSystemConnector is the Schema for the CloudDbSystemConnectors API. Provides the Cloud Db System Connector resource in Oracle Cloud Infrastructure Database Management service
...
type CloudDbSystemConnector struct {
	...
	Spec   CloudDbSystemConnectorSpec   `json:"spec"`
	Status CloudDbSystemConnectorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudDbSystemConnectorList contains a list of CloudDbSystemConnectors
type CloudDbSystemConnectorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudDbSystemConnector `json:"items"`
}

// Repository type metadata.
var (
	CloudDbSystemConnector_Kind             = "CloudDbSystemConnector"
	CloudDbSystemConnector_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudDbSystemConnector_Kind}.String()
	CloudDbSystemConnector_KindAPIVersion   = CloudDbSystemConnector_Kind + "." + CRDGroupVersion.String()
	CloudDbSystemConnector_GroupVersionKind = CRDGroupVersion.WithKind(CloudDbSystemConnector_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudDbSystemConnector{}, &CloudDbSystemConnectorList{})
}
