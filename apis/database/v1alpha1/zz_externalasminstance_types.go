...
type ExternalAsmInstanceInitParameters struct {
...
type ExternalAsmInstanceObservation struct {
...
// ExternalAsmInstanceSpec defines the desired state of ExternalAsmInstance
type ExternalAsmInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalAsmInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalAsmInstanceInitParameters `json:"initProvider,omitempty"`
}

// ExternalAsmInstanceStatus defines the observed state of ExternalAsmInstance.
type ExternalAsmInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalAsmInstanceObservation `json:"atProvider,omitempty"`
}
...
// ExternalAsmInstance is the Schema for the ExternalAsmInstances API. Provides the External Asm Instance resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalAsmInstance struct {
	...
	Spec   ExternalAsmInstanceSpec   `json:"spec"`
	Status ExternalAsmInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalAsmInstanceList contains a list of ExternalAsmInstances
type ExternalAsmInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalAsmInstance `json:"items"`
}

// Repository type metadata.
var (
	ExternalAsmInstance_Kind             = "ExternalAsmInstance"
	ExternalAsmInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalAsmInstance_Kind}.String()
	ExternalAsmInstance_KindAPIVersion   = ExternalAsmInstance_Kind + "." + CRDGroupVersion.String()
	ExternalAsmInstance_GroupVersionKind = CRDGroupVersion.WithKind(ExternalAsmInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalAsmInstance{}, &ExternalAsmInstanceList{})
}
