...
type ExternalDbHomeInitParameters struct {
...
type ExternalDbHomeObservation struct {
...
type ExternalDbHomeParameters struct {
...
// ExternalDbHomeSpec defines the desired state of ExternalDbHome
type ExternalDbHomeSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ExternalDbHomeParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ExternalDbHomeInitParameters `json:"initProvider,omitempty"`
}

// ExternalDbHomeStatus defines the observed state of ExternalDbHome.
type ExternalDbHomeStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ExternalDbHomeObservation `json:"atProvider,omitempty"`
}
...
// ExternalDbHome is the Schema for the ExternalDbHomes API. Provides the External Db Home resource in Oracle Cloud Infrastructure Database Management service
...
type ExternalDbHome struct {
	...
	Spec   ExternalDbHomeSpec   `json:"spec"`
	Status ExternalDbHomeStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ExternalDbHomeList contains a list of ExternalDbHomes
type ExternalDbHomeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ExternalDbHome `json:"items"`
}

// Repository type metadata.
var (
	ExternalDbHome_Kind             = "ExternalDbHome"
	ExternalDbHome_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ExternalDbHome_Kind}.String()
	ExternalDbHome_KindAPIVersion   = ExternalDbHome_Kind + "." + CRDGroupVersion.String()
	ExternalDbHome_GroupVersionKind = CRDGroupVersion.WithKind(ExternalDbHome_Kind)
)

func init() {
	SchemeBuilder.Register(&ExternalDbHome{}, &ExternalDbHomeList{})
}
