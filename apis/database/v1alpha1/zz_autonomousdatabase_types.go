...
type AutonomousDatabaseInitParameters struct {
	...
	// (Applicable when source=BACKUP_FROM_ID | BACKUP_FROM_TIMESTAMP) A list of the source Autonomous Database's table space number(s) used to create this partial clone from the backup.
	...
	// (Applicable when source=CLONE_TO_REFRESHABLE) (Updatable) Indicates the Autonomous Database mode. The database can be opened in READ_ONLY or READ_WRITE mode.
	...
	// The OCID of the source Autonomous Database that will be used to create a new peer database for the Data Guard association.
