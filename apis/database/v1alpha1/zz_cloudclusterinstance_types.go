...
type CloudClusterInstanceInitParameters struct {
...
type CloudClusterInstanceObservation struct {
...
type CloudClusterInstanceParameters struct {
...
// CloudClusterInstanceSpec defines the desired state of CloudClusterInstance
type CloudClusterInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CloudClusterInstanceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudClusterInstanceInitParameters `json:"initProvider,omitempty"`
}

// CloudClusterInstanceStatus defines the observed state of CloudClusterInstance.
type CloudClusterInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudClusterInstanceObservation `json:"atProvider,omitempty"`
}
...
// CloudClusterInstance is the Schema for the CloudClusterInstances API. Provides the Cloud Cluster Instance resource in Oracle Cloud Infrastructure Database Management service
...
type CloudClusterInstance struct {
	...
	Spec   CloudClusterInstanceSpec   `json:"spec"`
	Status CloudClusterInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudClusterInstanceList contains a list of CloudClusterInstances
type CloudClusterInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudClusterInstance `json:"items"`
}

// Repository type metadata.
var (
	CloudClusterInstance_Kind             = "CloudClusterInstance"
	CloudClusterInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudClusterInstance_Kind}.String()
	CloudClusterInstance_KindAPIVersion   = CloudClusterInstance_Kind + "." + CRDGroupVersion.String()
	CloudClusterInstance_GroupVersionKind = CRDGroupVersion.WithKind(CloudClusterInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudClusterInstance{}, &CloudClusterInstanceList{})
}
