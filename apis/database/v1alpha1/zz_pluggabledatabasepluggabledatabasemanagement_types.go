...
type PluggableDatabasePluggabledatabasemanagementConnectionStringsInitParameters struct {
}

type PluggableDatabasePluggabledatabasemanagementConnectionStringsObservation struct {
...
type PluggableDatabasePluggabledatabasemanagementConnectionStringsParameters struct {
}

type PluggableDatabasePluggabledatabasemanagementInitParameters struct {
...
type PluggableDatabasePluggabledatabasemanagementObservation struct {

	// The OCID of the compartment.
	CompartmentID *string `json:"compartmentId,omitempty" tf:"compartment_id,omitempty"`

	// Connection strings to connect to an Oracle Pluggable Database.
	ConnectionStrings []PluggableDatabasePluggabledatabasemanagementConnectionStringsObservation `json:"connectionStrings,omitempty" tf:"connection_strings,omitempty"`
	...
	PluggableDatabaseManagementConfig []PluggableDatabasePluggabledatabasemanagementPluggableDatabaseManagementConfigObservation `json:"pluggableDatabaseManagementConfig,omitempty" tf:"pluggable_database_management_config,omitempty"`
...
type PluggableDatabasePluggabledatabasemanagementParameters struct {
...
type PluggableDatabasePluggabledatabasemanagementPluggableDatabaseManagementConfigInitParameters struct {
}

type PluggableDatabasePluggabledatabasemanagementPluggableDatabaseManagementConfigObservation struct {
...
type PluggableDatabasePluggabledatabasemanagementPluggableDatabaseManagementConfigParameters struct {
}

// PluggableDatabasePluggabledatabasemanagementSpec defines the desired state of PluggableDatabasePluggabledatabasemanagement
type PluggableDatabasePluggabledatabasemanagementSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PluggableDatabasePluggabledatabasemanagementParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PluggableDatabasePluggabledatabasemanagementInitParameters `json:"initProvider,omitempty"`
}

// PluggableDatabasePluggabledatabasemanagementStatus defines the observed state of PluggableDatabasePluggabledatabasemanagement.
type PluggableDatabasePluggabledatabasemanagementStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PluggableDatabasePluggabledatabasemanagementObservation `json:"atProvider,omitempty"`
}
...
// PluggableDatabasePluggabledatabasemanagement is the Schema for the PluggableDatabasePluggabledatabasemanagements API. Provides the Pluggable Database Pluggabledatabasemanagements Management resource in Oracle Cloud Infrastructure Database service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type PluggableDatabasePluggabledatabasemanagement struct {
	...
	Spec   PluggableDatabasePluggabledatabasemanagementSpec   `json:"spec"`
	Status PluggableDatabasePluggabledatabasemanagementStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PluggableDatabasePluggabledatabasemanagementList contains a list of PluggableDatabasePluggabledatabasemanagements
type PluggableDatabasePluggabledatabasemanagementList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PluggableDatabasePluggabledatabasemanagement `json:"items"`
}

// Repository type metadata.
var (
	PluggableDatabasePluggabledatabasemanagement_Kind             = "PluggableDatabasePluggabledatabasemanagement"
	PluggableDatabasePluggabledatabasemanagement_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PluggableDatabasePluggabledatabasemanagement_Kind}.String()
	PluggableDatabasePluggabledatabasemanagement_KindAPIVersion   = PluggableDatabasePluggabledatabasemanagement_Kind + "." + CRDGroupVersion.String()
	PluggableDatabasePluggabledatabasemanagement_GroupVersionKind = CRDGroupVersion.WithKind(PluggableDatabasePluggabledatabasemanagement_Kind)
)

func init() {
	SchemeBuilder.Register(&PluggableDatabasePluggabledatabasemanagement{}, &PluggableDatabasePluggabledatabasemanagementList{})
}
