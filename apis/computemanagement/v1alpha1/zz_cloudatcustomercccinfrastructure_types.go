...
type CloudAtCustomerCccInfrastructureInitParameters struct {
...
type CloudAtCustomerCccInfrastructureObservation struct {
...
type CloudAtCustomerCccInfrastructureParameters struct {
...
// CloudAtCustomerCccInfrastructureSpec defines the desired state of CloudAtCustomerCccInfrastructure
type CloudAtCustomerCccInfrastructureSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     CloudAtCustomerCccInfrastructureParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider CloudAtCustomerCccInfrastructureInitParameters `json:"initProvider,omitempty"`
}

// CloudAtCustomerCccInfrastructureStatus defines the observed state of CloudAtCustomerCccInfrastructure.
type CloudAtCustomerCccInfrastructureStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        CloudAtCustomerCccInfrastructureObservation `json:"atProvider,omitempty"`
}
...
// CloudAtCustomerCccInfrastructure is the Schema for the CloudAtCustomerCccInfrastructures API. Provides the Ccc Infrastructure resource in Oracle Cloud Infrastructure Compute Cloud At Customer service
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,oci}
type CloudAtCustomerCccInfrastructure struct {
	...
	Spec   CloudAtCustomerCccInfrastructureSpec   `json:"spec"`
	Status CloudAtCustomerCccInfrastructureStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CloudAtCustomerCccInfrastructureList contains a list of CloudAtCustomerCccInfrastructures
type CloudAtCustomerCccInfrastructureList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CloudAtCustomerCccInfrastructure `json:"items"`
}

// Repository type metadata.
var (
	CloudAtCustomerCccInfrastructure_Kind             = "CloudAtCustomerCccInfrastructure"
	CloudAtCustomerCccInfrastructure_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CloudAtCustomerCccInfrastructure_Kind}.String()
	CloudAtCustomerCccInfrastructure_KindAPIVersion   = CloudAtCustomerCccInfrastructure_Kind + "." + CRDGroupVersion.String()
	CloudAtCustomerCccInfrastructure_GroupVersionKind = CRDGroupVersion.WithKind(CloudAtCustomerCccInfrastructure_Kind)
)

func init() {
	SchemeBuilder.Register(&CloudAtCustomerCccInfrastructure{}, &CloudAtCustomerCccInfrastructureList{})
}
