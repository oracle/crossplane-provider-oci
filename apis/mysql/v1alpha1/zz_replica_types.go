...
type ReplicaEncryptDataInitParameters struct {
}

type ReplicaEncryptDataObservation struct {
...
type ReplicaEncryptDataParameters struct {
}
...
type ReplicaObservation struct {
	...
	EncryptData []ReplicaEncryptDataObservation `json:"encryptData,omitempty" tf:"encrypt_data,omitempty"`
	...
	SecureConnections []ReplicaSecureConnectionsObservation `json:"secureConnections,omitempty" tf:"secure_connections,omitempty"`
...
type ReplicaSecureConnectionsInitParameters struct {
}

type ReplicaSecureConnectionsObservation struct {
...
type ReplicaSecureConnectionsParameters struct {
}
...
// Replica is the Schema for the Replicas API. Provides the Replica resource in Oracle Cloud Infrastructure MySQL Database service
