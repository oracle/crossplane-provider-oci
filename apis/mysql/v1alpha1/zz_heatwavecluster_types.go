...
type HeatWaveClusterSpec struct {
	...
	ForProvider     HeatWaveClusterParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider HeatWaveClusterInitParameters `json:"initProvider,omitempty"`
}

// HeatWaveClusterStatus defines the observed state of HeatWaveCluster.
type HeatWaveClusterStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        HeatWaveClusterObservation `json:"atProvider,omitempty"`
}
...
// HeatWaveCluster is the Schema for the HeatWaveClusters API. Provides the HeatWave cluster resource in Oracle Cloud Infrastructure MySQL Database service
...
type HeatWaveCluster struct {
	...
	Spec   HeatWaveClusterSpec   `json:"spec"`
	Status HeatWaveClusterStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// HeatWaveClusterList contains a list of HeatWaveClusters
...
var (
	HeatWaveCluster_Kind             = "HeatWaveCluster"
	HeatWaveCluster_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: HeatWaveCluster_Kind}.String()
	HeatWaveCluster_KindAPIVersion   = HeatWaveCluster_Kind + "." + CRDGroupVersion.String()
	HeatWaveCluster_GroupVersionKind = CRDGroupVersion.WithKind(HeatWaveCluster_Kind)
)
