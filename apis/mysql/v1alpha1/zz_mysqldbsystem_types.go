...
type MysqlDbSystemHeatWaveClusterInitParameters struct {
}

type MysqlDbSystemHeatWaveClusterObservation struct {
...
type MysqlDbSystemHeatWaveClusterParameters struct {
}
...
type MysqlDbSystemObservation struct {
	...
	HeatWaveCluster []MysqlDbSystemHeatWaveClusterObservation `json:"heatWaveCluster,omitempty" tf:"heat_wave_cluster,omitempty"`
