...
type TargetParameters struct {
	...
	// The OCID of the target DB System.
	// +kubebuilder:validation:Optional
	DBSystemID *string `json:"dbSystemId" tf:"db_system_id,omitempty"`
...
// Channel is the Schema for the Channels API. Provides the Channel resource in Oracle Cloud Infrastructure MySQL Database service
