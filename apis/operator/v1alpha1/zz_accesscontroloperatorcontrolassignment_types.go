...
type AccessControlOperatorControlAssignmentInitParameters struct {
...
type AccessControlOperatorControlAssignmentObservation struct {
...
type AccessControlOperatorControlAssignmentParameters struct {
...
// AccessControlOperatorControlAssignmentSpec defines the desired state of AccessControlOperatorControlAssignment
type AccessControlOperatorControlAssignmentSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     AccessControlOperatorControlAssignmentParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccessControlOperatorControlAssignmentInitParameters `json:"initProvider,omitempty"`
}

// AccessControlOperatorControlAssignmentStatus defines the observed state of AccessControlOperatorControlAssignment.
type AccessControlOperatorControlAssignmentStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccessControlOperatorControlAssignmentObservation `json:"atProvider,omitempty"`
}
...
// AccessControlOperatorControlAssignment is the Schema for the AccessControlOperatorControlAssignments API. Provides the Operator Control Assignment resource in Oracle Cloud Infrastructure Operator Access Control service
...
type AccessControlOperatorControlAssignment struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.operatorControlId) || (has(self.initProvider) && has(self.initProvider.operatorControlId))",message="spec.forProvider.operatorControlId is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.resourceCompartmentId) || (has(self.initProvider) && has(self.initProvider.resourceCompartmentId))",message="spec.forProvider.resourceCompartmentId is a required parameter"
	...
	Spec   AccessControlOperatorControlAssignmentSpec   `json:"spec"`
	Status AccessControlOperatorControlAssignmentStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AccessControlOperatorControlAssignmentList contains a list of AccessControlOperatorControlAssignments
type AccessControlOperatorControlAssignmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AccessControlOperatorControlAssignment `json:"items"`
}

// Repository type metadata.
var (
	AccessControlOperatorControlAssignment_Kind             = "AccessControlOperatorControlAssignment"
	AccessControlOperatorControlAssignment_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AccessControlOperatorControlAssignment_Kind}.String()
	AccessControlOperatorControlAssignment_KindAPIVersion   = AccessControlOperatorControlAssignment_Kind + "." + CRDGroupVersion.String()
	AccessControlOperatorControlAssignment_GroupVersionKind = CRDGroupVersion.WithKind(AccessControlOperatorControlAssignment_Kind)
)

func init() {
	SchemeBuilder.Register(&AccessControlOperatorControlAssignment{}, &AccessControlOperatorControlAssignmentList{})
}
