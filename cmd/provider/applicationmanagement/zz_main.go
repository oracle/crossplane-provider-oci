...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "OCI support for Crossplane - applicationmanagement Service.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-oci-applicationmanagement"))
	if debugValue {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-oci-applicationmanagement",
	...
	kingpin.FatalIfError(controller.Setup_applicationmanagement(mgr, o), "Cannot setup applicationmanagement controllers")
