...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "OCI support for Crossplane - bigdataservice Service.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-oci-bigdataservice"))
	if debugValue {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-oci-bigdataservice",
	...
	kingpin.FatalIfError(controller.Setup_bigdataservice(mgr, o), "Cannot setup bigdataservice controllers")
