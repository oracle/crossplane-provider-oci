...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "OCI support for Crossplane - digitalassistant Service.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-oci-digitalassistant"))
	if debugValue {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-oci-digitalassistant",
	...
	kingpin.FatalIfError(controller.Setup_digitalassistant(mgr, o), "Cannot setup digitalassistant controllers")
