...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "OCI support for Crossplane - emaildataplane Service.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-oci-emaildataplane"))
	if debugValue {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-oci-emaildataplane",
	...
	kingpin.FatalIfError(controller.Setup_emaildataplane(mgr, o), "Cannot setup emaildataplane controllers")
